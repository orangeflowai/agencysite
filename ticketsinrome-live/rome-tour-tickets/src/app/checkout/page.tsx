    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                <div className="flex items-start gap-3">
                    ...
                    <label htmlFor="policy-accept" className="text-sm text-gray-600 leading-relaxed cursor-pointer">
                        I have read and agree to the <Link href="/terms-and-conditions" className="text-gray-900 font-semibold hover:underline">Terms & Conditions</Link>,{''} <Link href="/privacy-policy" className="text-gray-900 font-semibold hover:underline">Privacy Policy</Link>, and{''} <Link href="/cancellation-policy" className="text-gray-900 font-semibold hover:underline">Cancellation Policy</Link>.
                    </label>
                </div>
            </div>
            ...
            <button
                ...
                className={`w-full py-4 rounded-xl transition-all flex items-center justify-center gap-2 font-bold text-base ${!stripe || isProcessing || !policyAccepted ? 'bg-gray-200 text-gray-400 cursor-not-allowed' : 'bg-emerald-600 hover:bg-emerald-700 text-white shadow-md shadow-emerald-200 active:scale-95'}`}
            >
                {isProcessing ? (
                    <>
