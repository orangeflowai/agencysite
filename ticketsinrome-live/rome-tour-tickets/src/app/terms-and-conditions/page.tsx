            ...
            <div className="container mx-auto px-4 py-24 max-w-4xl">
                ...
                <div className="prose prose-lg prose-emerald text-gray-600 max-w-none space-y-8">
                    <p className="lead text-xl text-gray-800 font-medium">
                        Please read these Terms and Conditions carefully before booking any services with Tickets in Rome. By making a booking and payment, you agree to be bound by these terms. Contact us first if anything is unclear.
                    </p>

                    <h3 className="text-2xl font-bold text-gray-900 mt-12">Coupons, Discounts & Promotions</h3>
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mt-12">Liability & Limitations</h3>
                    <p>Tickets in Rome is not liable for personal injury, loss/damage to property or luggage, death, or any other loss during tours or transfers. We accept no responsibility for delays, inconveniences, or problems caused by events outside our reasonable control (force majeure), including war, strikes, weather, natural disasters, government restrictions, or site closures.</p>

                    <h3 className="text-2xl font-bold text-gray-900 mt-12">Travel Insurance Recommendation</h3>
                    <p>We strongly advise all travelers to purchase comprehensive travel insurance that covers trip cancellation, medical emergencies, evacuation, and lost belongings. Tickets in Rome is not responsible for any related costs if these events occur.</p>

                    <h3 className="text-2xl font-bold text-gray-900 mt-12">SMS / WhatsApp Updates</h3>
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mt-12">Late Arrivals Policy</h3>
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mt-12">ID & Age Requirements</h3>
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mt-12">Special Ticketed Sites (e.g., Colosseum, Vatican)</h3>
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mt-12">Itinerary Changes</h3>
                    <p>Tour routes or site order may be adjusted for safety, crowds, logistics, or guide decision. No refunds for such changes.</p>

                    <h3 className="text-2xl font-bold text-gray-900 mt-12">Events Outside Our Control</h3>
                    <ul className="list-disc pl-5 space-y-2">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mt-12">Discounts & Last-Minute Bookings</h3>
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mt-12">Group Size Policy</h3>
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mt-12">Governing Law</h3>
                    ...
                    <ul className="list-none pl-0 space-y-2">
                        ...
                        <li><strong>Phone:</strong> <a href="tel:+393517869798" className="text-emerald-700 font-bold hover:underline">+39 351 7869798</a></li>
                    </ul>
                </div>
