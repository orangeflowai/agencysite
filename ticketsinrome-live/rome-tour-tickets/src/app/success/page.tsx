                                    ...
                                    <div className="space-y-2">
                                                ...
                                                <div className="space-y-1">
                                                    {booking.guest_details.guests.slice(0, 5).map((guest: any, i: number) => (
                                                        <p key={i} className="text-sm text-gray-700">
                                                            {guest.index}. {guest.name} <span className="text-gray-400">({guest.type})</span>
                                                        </p>
                                                    ))}
                                        ...
                                        <div className="border-t-2 border-gray-200 pt-3 mt-3">
                                            <div className="flex justify-between items-center">
                                                ...
                                                <span className="font-bold text-emerald-600 text-2xl">€{booking.total_price.toFixed(2)}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
