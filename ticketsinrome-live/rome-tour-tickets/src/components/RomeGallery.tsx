...
const images = [
  ...
  { src: 'https://images.unsplash.com/photo-1633321702518-7feccafb94d5?auto=format&fit=crop&q=75&w=600', alt: 'Pantheon, Rome' },
  ...
  { src: 'https://images.unsplash.com/photo-1601581875309-fafbf2d3ed3a?auto=format&fit=crop&q=75&w=600', alt: 'Piazza Navona, Rome' },
];
