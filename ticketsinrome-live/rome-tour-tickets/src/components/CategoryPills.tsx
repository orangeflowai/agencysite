...
const CATEGORIES = [
  { icon: '⛪', name: 'Vatican',       count: '28 tours', href: '/category/vatican',   color: 'hover:bg-emerald-50 hover:border-emerald-300' },
    ...
    <section className="bg-white py-10 border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          ...
          <Link href="/search" className="text-sm font-semibold text-emerald-600 hover:text-emerald-700 transition-colors">
            See all tours →
          </Link>
        </div>
