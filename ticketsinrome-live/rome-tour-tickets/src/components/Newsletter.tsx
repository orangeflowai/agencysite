                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-8 max-w-7xl mx-auto">
                    ...
                    <div className="flex items-center gap-6 w-full lg:w-1/3 justify-center lg:justify-start">
                        <div className="relative">
                            ...
                            <Bell size={24} className="absolute -bottom-2 -right-2 text-emerald-400 fill-stone-900 bg-stone-900 rounded-full p-0.5" />
                        </div>
                    ...
                    <div className="w-full lg:w-1/3">
                        <form onSubmit={handleSubmit} className="flex items-center w-full max-w-md mx-auto bg-stone-800 border border-stone-700 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-emerald-500/20 transition-all shadow-sm">
                            <input
                                type="email"
                                required
                                value={email}
                            ...
                            <button
                                type="submit"
                                disabled={status === 'loading'}
                                className="bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold uppercase tracking-widest px-6 py-4 transition-colors disabled:opacity-50"
                            >
                        ...
                        <div className="flex gap-4">
                            {[
                                ...
                                <a
                                    key={i}
                                    href={href}
                                    className="block p-2 rounded-full bg-stone-800 text-gray-400 hover:bg-emerald-600 hover:text-white transition-all transform hover:-translate-y-1"
                                >
                                    <Icon size={18} />
                                </a>
                            ))}
