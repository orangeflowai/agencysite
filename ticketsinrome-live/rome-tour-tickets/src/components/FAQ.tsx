            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-16">
                    <span className="text-emerald-600 font-black uppercase tracking-widest text-xs mb-2 block">
                        Support & Help
                    </span>
                        ...
                        return (
                            <motion.div
                                ...
                                className={clsx(
                                    ...
                                    isOpen
                                        ? "bg-white border-emerald-200 shadow-xl shadow-emerald-900/5"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className={clsx(
                                        ...
                                        isOpen ? "bg-emerald-600 text-white rotate-180" : "bg-gray-50 text-gray-400 group-hover:bg-emerald-50 group-hover:text-emerald-600"
                                    )}>
