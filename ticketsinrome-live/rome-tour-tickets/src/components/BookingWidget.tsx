            ...
            <div className="bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-gray-100/50 overflow-hidden">
                ...
                <div className="p-8 border-t border-gray-100 bg-white">
                    ...
                    <div className="grid gap-3">
                        ...
                        {validationError && (
                            <div className="px-4 py-3 bg-rose-50 border border-rose-200 rounded-xl text-xs font-bold text-rose-600 flex items-center gap-2">
                        ...
                        <button
                            ...
                            className="w-full py-3 rounded-2xl font-bold text-xs uppercase tracking-widest transition-all duration-300 flex items-center justify-center gap-2 text-gray-400 hover:text-emerald-600 disabled:opacity-30"
                        >
