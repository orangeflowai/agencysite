    ...
    return (
        <Popover.Root>
            <Popover.Trigger asChild>
                <button className="w-full p-6 border-b border-gray-100 flex items-center gap-3 hover:bg-muted transition-colors text-left outline-none group">
            ...
            <Popover.Portal>
                <Popover.Content className="w-60 bg-card rounded-xl shadow-xl border border-gray-100 p-2 z-50 animate-in fade-in zoom-in-95 duration-200" side="bottom" align="start" sideOffset={5}>
