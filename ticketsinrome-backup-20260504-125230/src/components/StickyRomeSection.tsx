                ...
                <div className="h-screen flex items-center justify-center sticky top-0"> {/* Overlaying sticky for fade effect */}
                    <motion.div style={{ opacity: text2Opacity, y: text2Y }} className="max-w-4xl text-center z-20 px-4">
                        ...
                        <div className="flex justify-center gap-4 pointer-events-auto"> {/* Pointer events back on for buttons */}
                            <Link href="/search" className="bg-primary hover:opacity-90 text-white px-8 py-4 rounded-full font-bold  tracking-widest transition-all">
                                Find Your Experience
                            </Link>
                            <Link href="/private-tours" className="bg-card hover:bg-gray-100 text-black px-8 py-4 rounded-full font-bold  tracking-widest transition-all">
                                View Private Tours
                            </Link>
                        </div>
                    </motion.div>
