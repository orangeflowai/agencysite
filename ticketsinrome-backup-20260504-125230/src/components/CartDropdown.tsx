        ...
        <div className="relative">
            ...
            {isCartOpen && (
                <>
                    ...
                    />
                    <div className="absolute right-0 top-full mt-2 w-80 md:w-96 bg-card rounded-xl shadow-2xl border border-gray-100 z-50 overflow-hidden">
                        <div className="p-4 border-b border-gray-100 flex items-center justify-between">
                            <h3 className="font-bold text-foreground">Your Cart ({totalItems})</h3>
                            <button
                                onClick={() => setIsCartOpen(false)}
                        ...
                        {items.length === 0 ? (
                            ...
                            <>
                                ...
                                <div className="p-4 bg-muted border-t border-gray-100">
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-primary hover:opacity-90 text-white font-bold py-3 rounded-xl transition-colors"
                                    >
                                        Proceed to Checkout
                                    </button>
                                </div>
...
export default function CartDropdown() {
    return (
        <Suspense fallback={<ShoppingBag className="w-5 h-5 text-muted-foreground" />}>
            <CartContent />
        </Suspense>
    );
}
