        ...
        <div className="min-h-screen bg-gradient-to-b from-emerald-50 via-white to-gray-50">
            ...
            <main className="max-w-4xl mx-auto px-4 py-8">
                ...
                <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl p-8 text-white mb-8 text-center relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-40 h-40 bg-card/10 rounded-full -translate-y-1/2 translate-x-1/2"></div>
                    <div className="absolute bottom-0 left-0 w-24 h-24 bg-card/10 rounded-full translate-y-1/2 -translate-x-1/2"></div>

                    <div className="relative z-10">
                        <div className="w-20 h-20 bg-card/20 rounded-full flex items-center justify-center mx-auto mb-4">
                    ...
                    <>
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                ...
                                <div className="flex gap-3">
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-4 py-2.5 bg-primary text-white font-medium rounded-xl hover:opacity-90 transition-colors"
                                    >
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="flex gap-4">
                                            ...
                                            <div className="flex-1">
                                                <h2 className="text-xl font-bold text-foreground">{booking.tour_title}</h2>
                                            ...
                                            <div className="border-t border-border pt-6">
                                                ...
                                                <div className="bg-emerald-50 rounded-xl p-4">
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div>
                                                            <p className="font-semibold text-foreground">{booking.guide_name}</p>
                                                            <p className="text-sm text-gray-600">Expert Local Guide</p>
                                                        </div>
                                                        <a
                                                            href={`tel:${booking.guide_phone}`}
                                                            className="ml-auto flex items-center gap-1 px-3 py-1.5 bg-card rounded-lg text-primary font-medium text-sm hover:bg-emerald-100 transition-colors"
                                                        >
                                ...
                                {activeTab === 'tickets' && (
                                    <div className="space-y-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <button
                                                onClick={downloadTicket}
                                                className="flex items-center gap-3 p-4 bg-muted rounded-xl border-2 border-border hover:border-emerald-500 hover:bg-emerald-50 transition-colors text-left"
                                            >
                                                <div className="w-12 h-12 bg-emerald-100 rounded-lg flex items-center justify-center">
                                                    <FileText className="w-6 h-6 text-primary" />
                                                </div>
                                                <div>
                                                    <p className="font-semibold text-foreground">Download PDF Ticket</p>
                                                    <p className="text-sm text-muted-foreground">Print or save to your phone</p>
                                                </div>
                                            </button>
                                            ...
                                            >
                                                ...
                                                <div>
                                                    <p className="font-semibold text-foreground">Print Ticket</p>
                                                    <p className="text-sm text-muted-foreground">Open print dialog</p>
                                                </div>
                                            </button>
                                        </div>
                                        ...
                                        <div className="bg-muted rounded-xl p-4 border border-border">
                                            <p className="font-medium text-foreground mb-3">Add to Phone Wallet</p>
                                            <div className="flex gap-3">
                                                ...
                                                <button className="flex items-center gap-2 px-4 py-2 bg-card border border-gray-300 text-gray-800 rounded-lg text-sm font-medium hover:bg-muted transition-colors">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <button
                                                ...
                                                className="flex items-center gap-3 p-4 bg-muted rounded-xl border-2 border-border hover:border-gray-500 transition-colors text-left"
                                            >
                                                <div className="w-12 h-12 bg-gray-200 rounded-lg flex items-center justify-center">
                                                    <Copy className="w-6 h-6 text-gray-600" />
                                                </div>
                                                <div>
                                                    <p className="font-semibold text-foreground">Copy Link</p>
                                                    <p className="text-sm text-muted-foreground">Copy booking URL</p>
                                                </div>
                                            </button>
                                            ...
                                            >
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm text-muted-foreground">Native share menu</p>
                                                </div>
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">We've sent your tickets and details</p>
                                    </div>
                                </div>
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">Save them offline on your phone</p>
                                    </div>
                                </div>
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">We'll send you a reminder</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-8 text-center">
                            ...
                            <div className="flex justify-center gap-4">
                                <a
                                    href="tel:3517869798"
                                    className="flex items-center gap-2 px-4 py-2 bg-card border border-border rounded-lg text-gray-700 hover:bg-muted transition-colors"
                                >
                                    <Phone className="w-4 h-4" />
                                    Call Us
                                </a>
