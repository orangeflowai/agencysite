        ...
        <main className="min-h-screen bg-cream selection:bg-olive selection:text-white">
            ...
            <div className="container mx-auto px-4 py-24 max-w-4xl">
                ...
                <div className="prose prose-lg prose-emerald text-gray-600 max-w-none space-y-8">
                    ...
                    <p>
                        All cancellation requests must be submitted in writing via email to <a href="mailto:info@ticketsinrome.com" className="text-emerald-700 font-bold hover:underline">info@ticketsinrome.com</a> or by contacting our customer service at <a href="tel:+393517869798" className="text-emerald-700 font-bold hover:underline">+39 351 7869798</a>. The timing is calculated in Rome local time (CET/CEST).
                    </p>
                    ...
                    <h3 className="text-2xl font-bold text-foreground mt-12">7. Cancellations by Tickets in Rome</h3>
                    ...
                    <p>We strongly recommend purchasing comprehensive travel insurance that covers tour cancellations, medical emergencies, and lost luggage. Tickets in Rome is not responsible for any costs arising from cancellations due to personal reasons.</p>
                    ...
                    <ul className="list-none pl-0 space-y-2">
                        <li><strong>Email:</strong> <a href="mailto:info@ticketsinrome.com" className="text-emerald-700 font-bold hover:underline">info@ticketsinrome.com</a></li>
                        <li><strong>Phone/WhatsApp:</strong> <a href="tel:+393517869798" className="text-emerald-700 font-bold hover:underline">+39 351 7869798</a></li>
                    </ul>

                    <p className="mt-12 text-center font-bold text-foreground">
                        Thank you for choosing Tickets in Rome. We look forward to giving you an unforgettable experience in the Eternal City of Rome!
                    </p>
                </div>
