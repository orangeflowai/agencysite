            ...
            <div className="container mx-auto px-4 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
                        ...
                        <div className="space-y-8">
                            <div className="flex items-start space-x-6 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 font-medium hover:text-olive transition-colors cursor-pointer">info@ticketsinrome.com</p>
                            ...
                            <div className="flex items-start space-x-6 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 font-medium">351 786 9798</p>
                    ...
                    <motion.div
                        ...
                        className="bg-card p-8 md:p-10 rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 relative overflow-hidden"
                    >
