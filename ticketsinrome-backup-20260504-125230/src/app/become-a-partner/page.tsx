...
export const metadata = {
    title: 'Become a Partner | TicketsInRome',
            ...
            <div className="relative bg-emerald-900 text-white overflow-hidden">
                ...
                <div className="container mx-auto px-4 py-32 relative z-10 text-center">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight leading-none">
                        Grow with <span className="text-emerald-400">Tickets in Rome</span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <a href="mailto:partners@ticketsinrome.com" className="px-8 py-4 bg-card text-emerald-900 font-bold rounded-lg hover:bg-emerald-50 transition-all transform hover:-translate-y-1 shadow-lg shadow-emerald-900/50 flex items-center gap-2">
                            <Mail size={20} />
            ...
            <div className="py-24 bg-muted border-y border-border">
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row items-center gap-16">
                        ...
                        <div className="flex-1 bg-card p-8 rounded-3xl shadow-xl border border-gray-100">
