                ...
                <div className="grid gap-6">
                    <div className="bg-card rounded-2xl shadow-sm border border-gray-100 p-6">
                        ...
                        <div className="mt-8 p-4 bg-muted rounded-xl border border-border">
                            ...
                            <div className="bg-card rounded-xl shadow-lg border border-gray-100 p-4">
                                ...
                                <div className="flex gap-2">
                                    <button className="px-4 py-2 rounded-lg border border-border text-gray-600 text-sm font-medium">
