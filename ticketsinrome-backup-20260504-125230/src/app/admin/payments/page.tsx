...
import { 
    CreditCard, Wallet, Building2, Globe, Check,
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-6 flex justify-center">
                <a 
                    ...
                    className="flex items-center gap-2 px-6 py-3 bg-card border border-border text-gray-700 font-medium rounded-xl hover:bg-muted transition-colors"
                >
