...
export default function AddOnsAdminPage() {
    ...
    const fetchAddOns = async () => {
        setLoading(true);
        try {
            const response = await fetch(`/api/admin/addons?site=${currentSite?.slug?.current || process.env.NEXT_PUBLIC_SITE_ID || 'goldenrometour'}`);
    ...
    return (
        <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-8">
                ...
                <button
                    onClick={handleNew}
                    className="flex items-center gap-2 px-4 py-2 bg-primary text-white font-medium rounded-lg hover:opacity-90 transition-colors"
                >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2 border border-border rounded-lg focus:ring-2 focus:ring-emerald-500 outline-none"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2 border border-border rounded-lg focus:ring-2 focus:ring-emerald-500 outline-none font-mono text-sm"
                            ...
                            <div className="flex items-center gap-6">
                                <label className="flex items-center gap-2 cursor-pointer">
                                    <input
                                        ...
                                        className="w-5 h-5 text-primary rounded focus:ring-emerald-500"
                                    />
                        ...
                        <div className="flex items-center justify-end gap-3 pt-4 border-t">
                            ...
                            <button
                                type="submit"
                                disabled={saving}
                                className="flex items-center gap-2 px-6 py-2 bg-primary text-white font-medium rounded-lg hover:opacity-90 transition-colors disabled:opacity-50"
                            >
                                {saving ? (
