                ...
                <div className="container mx-auto px-4 text-center">
                    <div className="max-w-3xl mx-auto bg-foreground text-background p-12 lg:p-16 rounded-[3rem] shadow-2xl relative overflow-hidden">
                        ...
                        <div className="grid sm:grid-cols-2 gap-6 mb-12 relative z-10">
                            <a href="https://wa.me/3514199425" className="flex items-center justify-center gap-3 bg-emerald-600 hover:bg-emerald-700 text-white py-4 px-8 rounded-2xl font-bold transition-all transform hover:scale-[1.02] uppercase tracking-widest text-xs">
                    ...
                    <p className="mt-12 text-[10px] font-black text-muted-foreground uppercase tracking-[0.5em]">Wonders Of Rome // Official Archives.</p>
                </div>
            </section>
