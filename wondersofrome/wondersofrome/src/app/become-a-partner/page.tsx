            ...
            <div className="relative bg-emerald-900 text-white overflow-hidden">
                ...
                <div className="container mx-auto px-4 py-32 relative z-10 text-center">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight leading-none">
                        Grow with <span className="text-emerald-400">Wonders of Rome</span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <a href="mailto:partners@wondersofrome.com" className="px-8 py-4 bg-card text-emerald-900 font-bold rounded-lg hover:bg-secondary transition-all transform hover:-translate-y-1 shadow-lg shadow-emerald-900/50 flex items-center gap-2">
                            <Mail size={20} />
            ...
            <div id="benefits" className="py-24 bg-card">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {/* Benefit 1 */}
                        <div className="p-8 rounded-2xl bg-cream-50 border border-border hover:border-emerald-200 hover:shadow-lg transition-all group">
