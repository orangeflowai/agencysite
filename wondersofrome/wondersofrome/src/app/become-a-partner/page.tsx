            ...
            <div className="relative bg-emerald-900 text-white overflow-hidden">
                ...
                <div className="container mx-auto px-4 py-32 relative z-10 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <a href="mailto:partners@wondersofrome.com" className="px-8 py-4 bg-white text-emerald-900 font-bold rounded-lg hover:bg-emerald-50 transition-all transform hover:-translate-y-1 shadow-lg shadow-emerald-900/50 flex items-center gap-2">
                            <Mail size={20} />
