    ...
    <main className="min-h-screen bg-background selection:bg-primary selection:text-white font-sans">
      ...
      <div className="border-b border-border bg-white py-12">
          <div className="container mx-auto px-6 text-center">
            <h3 className="text-[#8A8A8A] font-bold uppercase tracking-widest text-[10px] mb-8">Authenticated by 50,000+ Verified Logs</h3>
            <div className="flex flex-wrap justify-center items-center gap-12 opacity-40 hover:opacity-100 transition-all duration-500">
               ...
               <span className="font-serif font-bold text-xl text-foreground italic">Viator Elite</span>
               <span className="font-serif font-bold text-xl text-foreground italic">GetYourGuide</span>
            </div>
          </div>
      </div>
               ...
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                  <div className="relative aspect-[4/5] rounded-[3rem] overflow-hidden shadow-2xl group border-8 border-background">
                     ...
                     <div className="absolute top-10 left-10">
                        <span className="bg-primary text-white px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[0.4em] shadow-lg">Featured Archive</span>
                     </div>
                  </div>
                  <div className="space-y-8">
                     <div className="space-y-4">
                        <p className="text-primary font-black uppercase tracking-[0.4em] text-[10px]">Priority Selection</p>
                        <SplitText className="text-5xl md:text-7xl font-serif font-bold text-foreground leading-[0.9] tracking-tighter uppercase italic">{featuredTour.title}</SplitText>
                     </div>
                     ...
                     <div className="flex flex-wrap gap-8 items-center text-[10px] font-black uppercase tracking-widest text-muted-foreground border-y border-border py-6">
                     ...
                     <div className="flex items-center gap-6 pt-4">
                        <Link href={`/tour/${featuredTour.slug.current}`} className="bg-primary hover:bg-primary/90 text-white font-bold px-12 py-5 rounded-full uppercase tracking-widest text-xs transition-all shadow-xl hover:-translate-y-1 active:scale-95">
                           Initiate Tour
                        </Link>
             ...
             <div className="container mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                   <div className="space-y-12">
                      <div className="space-y-4">
                         <span className="inline-block px-4 py-1 bg-primary/10 border border-primary/20 text-primary text-[10px] font-black uppercase tracking-[0.4em] rounded-full">Next Gen Hardware</span>
                         <SplitText className="text-5xl md:text-7xl font-serif font-black leading-[0.85] italic text-white">THE WONDERS GUIDE APP</SplitText>
                      </div>
                      <p className="text-xl opacity-60 max-w-md font-mono leading-relaxed uppercase tracking-tighter">
                      ...
                      <div className="flex flex-wrap gap-6 pt-4">
                         <img src="https://pub-772bbb33a07f4026aa9652a0cfef4c2e.r2.dev/logod/applestore.png" alt="App Store" className="h-14 w-auto object-contain cursor-pointer hover:scale-105 transition-transform" />
                         <img src="https://pub-772bbb33a07f4026aa9652a0cfef4c2e.r2.dev/logod/googleplay.png" alt="Play Store" className="h-14 w-auto object-contain cursor-pointer hover:scale-105 transition-transform" />
                      </div>
                   </div>
                   <div className="relative">
                      <div className="relative z-10 w-full max-w-md mx-auto transform hover:rotate-2 transition-transform duration-1000">
                         <img src="https://pub-772bbb33a07f4026aa9652a0cfef4c2e.r2.dev/Gemini_Generated_Image_xucflixucflixucf.png" alt="Mobile App Mockup" className="w-full h-auto rounded-[3rem] shadow-[0_50px_100px_rgba(0,0,0,0.8)] border-[12px] border-[#222]" />
                      </div>
              ...
              <div className="container mx-auto px-6">
                  <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-16 gap-6">
                      <div className="max-w-xl">
                          <p className="text-primary font-black uppercase tracking-[0.4em] text-[10px] mb-4">Editorial Archive</p>
                          <SplitText className="text-5xl md:text-7xl font-serif font-bold tracking-tighter uppercase italic leading-none text-foreground">The Roman Journal</SplitText>
                      </div>
                      <Link href="/blog" className="inline-flex items-center gap-2 px-8 py-4 border-2 border-primary/20 text-primary text-[10px] font-black uppercase tracking-widest rounded-full hover:bg-primary hover:text-white transition-all shrink-0">
                      ...
                      {posts?.slice(0, 3).map((post: any) => (
                          <Link key={post._id} href={`/blog/${post.slug.current}`} className="group flex flex-col h-full bg-card rounded-[2.5rem] overflow-hidden border border-border hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                              <div className="relative aspect-[16/10] overflow-hidden">
                                  <img src={post.mainImage || pexelsVatican[1]?.url} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000" alt={post.title} />
                              </div>
                              <div className="p-10 flex flex-col flex-1">
                                  <span className="text-[10px] font-black uppercase tracking-widest text-primary mb-4 block">Archive Entry</span>
                                  <h3 className="text-2xl font-serif font-bold text-foreground mb-4 group-hover:text-primary transition-colors leading-tight italic">{post.title}</h3>
                                  ...
                                  <div className="mt-auto flex items-center justify-between pt-6 border-t border-border/50">
                                      <span className="text-[10px] font-black uppercase tracking-[0.2em] text-primary">Read Record</span>
        ...
        <div className="bg-foreground text-background py-32 border-b border-border relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-20">
               <p className="text-primary font-black uppercase tracking-[0.4em] text-[10px] mb-4">Verified Feedback</p>
               <SplitText className="text-5xl md:text-7xl font-serif font-bold tracking-tighter italic uppercase leading-none text-background justify-center">Guest Log Archives</SplitText>
            </div>
            <FloatingReviews />
          </div>
        </div>
