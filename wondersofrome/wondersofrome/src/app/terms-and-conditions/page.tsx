...
export const metadata: Metadata = {
    title: 'Terms and Conditions | Wonders of Rome',
    description: 'Terms and Conditions for use of Wonders of Rome services and website.',
};
            ...
            <div className="container mx-auto px-4 py-24 max-w-4xl">
                ...
                <div className="prose prose-lg prose-emerald text-gray-600 max-w-none space-y-8">
                    <p className="lead text-xl text-gray-800 font-medium">
                        Please read these Terms and Conditions carefully before booking any services with Wonders of Rome. By making a booking and payment, you agree to be bound by these terms. Contact us first if anything is unclear.
                    </p>
