                ...
                <div className="prose prose-lg prose-emerald text-muted-foreground max-w-none space-y-8">
                    ...
                    <div className="bg-card p-8 rounded-xl border border-border shadow-sm my-8">
                        ...
                        <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 list-none p-0">
                            <li><a href="#scope" className="text-primary hover:text-emerald-800 font-medium">1. What is the scope of this policy?</a></li>
                            <li><a href="#personal-info" className="text-primary hover:text-emerald-800 font-medium">2. Personal Information We Collect</a></li>
                            <li><a href="#other-info" className="text-primary hover:text-emerald-800 font-medium">3. Other Information we collect</a></li>
                            <li><a href="#usage" className="text-primary hover:text-emerald-800 font-medium">4. How do we use your personal information?</a></li>
                            <li><a href="#disclosure" className="text-primary hover:text-emerald-800 font-medium">5. Information Access and Disclosure</a></li>
                            <li><a href="#cookies" className="text-primary hover:text-emerald-800 font-medium">6. Cookie Policy</a></li>
                            <li><a href="#widgets" className="text-primary hover:text-emerald-800 font-medium">7. Third-Party Widgets</a></li>
                            <li><a href="#pixels" className="text-primary hover:text-emerald-800 font-medium">8. Tracking Pixels</a></li>
                            <li><a href="#security" className="text-primary hover:text-emerald-800 font-medium">9. Data Storage and Security</a></li>
                            <li><a href="#deletion" className="text-primary hover:text-emerald-800 font-medium">10. Can I delete my Personal Data?</a></li>
                            <li><a href="#children" className="text-primary hover:text-emerald-800 font-medium">11. Children’s Online Privacy Protection</a></li>
                            <li><a href="#changes" className="text-primary hover:text-emerald-800 font-medium">12. Changes to this Privacy Policy</a></li>
                            <li><a href="#contact" className="text-primary hover:text-emerald-800 font-medium">13. Contact Information & Feedback</a></li>
                        </ul>
                    </div>
