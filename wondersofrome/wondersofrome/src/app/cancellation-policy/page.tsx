    ...
    return (
        <main className="min-h-screen bg-background selection:bg-primary selection:text-white font-sans text-foreground">
            ...
            <div className="container mx-auto px-4 py-32 max-w-4xl">
                ...
                <p className="text-center text-muted-foreground mb-16 font-mono text-[10px] uppercase tracking-[0.4em]">Last Updated: February 20, 2026 // REF: POL-772-B</p>

                <div className="prose prose-lg mx-auto text-foreground/80 font-medium leading-relaxed space-y-12">
                    <p className="lead text-xl text-foreground font-serif italic border-l-4 border-primary pl-6">
                    ...
                    <section className="space-y-6">
                        <h3 className="text-2xl font-serif font-black italic uppercase tracking-tight text-primary">1. Booking Options at Checkout</h3>
                    ...
                    <section className="space-y-6">
                        <h3 className="text-2xl font-serif font-black italic uppercase tracking-tight text-primary">2. General Cancellation Rules</h3>
                        <p>
                    ...
                    <section className="space-y-6">
                        <h3 className="text-2xl font-serif font-black italic uppercase tracking-tight text-primary">3. Refund Eligibility Tiers</h3>
                        ...
                        <div className="overflow-hidden my-8 border border-border rounded-[2rem] shadow-sm bg-card">
                            <table className="min-w-full text-left text-sm md:text-base">
                                <thead className="bg-foreground text-background font-mono text-[10px] uppercase tracking-widest">
                                    <tr>
                                        <th className="py-5 px-8 font-black w-1/2">Time of Cancellation</th>
                                        <th className="py-5 px-8 font-black w-1/2">Refund Amount</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-border">
                                    <tr className="hover:bg-background/50 transition-colors">
                                        <td className="py-5 px-8 font-medium text-foreground">More than 6 working days before the tour</td>
                                        <td className="py-5 px-8 text-emerald-600 font-black font-mono">100% REFUND</td>
                                    </tr>
                                    <tr className="hover:bg-background/50 transition-colors">
                                        <td className="py-5 px-8 font-medium text-foreground">3 to 6 days before the tour</td>
                                        <td className="py-5 px-8 text-primary font-black font-mono">50% REFUND</td>
                                    </tr>
                                    <tr className="hover:bg-background/50 transition-colors">
                                        <td className="py-5 px-8 font-medium text-foreground">Less than 72 hours before the tour</td>
                                        <td className="py-5 px-8 text-destructive font-black font-mono">0% REFUND</td>
                                    </tr>
                                    <tr className="hover:bg-background/50 transition-colors">
                    ...
                    <div className="bg-primary/5 border border-primary/20 p-8 rounded-[2rem] relative overflow-hidden group">
                        ...
                        <p className="font-serif font-black italic uppercase tracking-tight text-primary mb-4 relative z-10">Critical Notice:</p>
                    ...
                    <section className="space-y-6 pt-12 border-t border-border">
                        <h3 className="text-xl font-serif font-black italic uppercase tracking-tight text-foreground">Operational Protocol</h3>
                ...
                <div className="mt-24 text-center">
                    <Link href="/contact" className="inline-flex items-center gap-2 bg-foreground text-background px-8 py-4 rounded-full font-bold uppercase tracking-widest text-xs hover:bg-primary transition-all">
