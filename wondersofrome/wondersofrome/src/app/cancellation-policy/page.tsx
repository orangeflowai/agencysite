        ...
        <main className="min-h-screen bg-cream selection:bg-olive selection:text-white">
            ...
            <div className="container mx-auto px-4 py-24 max-w-4xl">
                ...
                <div className="prose prose-lg prose-emerald text-gray-600 max-w-none space-y-8">
                    ...
                    <p>
                        All cancellation requests must be submitted in writing via email to <a href="mailto:info@wondersofrome.com" className="text-emerald-700 font-bold hover:underline">info@wondersofrome.com</a> or by contacting our customer service at <a href="tel:3514199425" className="text-emerald-700 font-bold hover:underline">351 419 9425</a>. The timing is calculated in Rome local time (CET/CEST).
                    </p>
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mt-12">7. Cancellations by Wonders of Rome</h3>
                    ...
                    <p>We strongly recommend purchasing comprehensive travel insurance that covers tour cancellations, medical emergencies, and lost luggage. Wonders of Rome is not responsible for any costs arising from cancellations due to personal reasons.</p>
                    ...
                    <ul className="list-none pl-0 space-y-2">
                        ...
                        <li><strong>Phone/WhatsApp:</strong> <a href="tel:3514199425" className="text-emerald-700 font-bold hover:underline">351 419 9425</a></li>
                    </ul>

                    <p className="mt-12 text-center font-bold text-gray-900">
                        Thank you for choosing Wonders of Rome. We look forward to giving you an unforgettable experience in the Eternal City!
                    </p>
                </div>
