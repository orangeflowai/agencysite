...
export async function generateTicketPDF(data: TicketData): Promise<Uint8Array> {
    ...
    // Colors - Sky blue theme for Wonders of Rome
    const primaryColor = data.siteName === 'wondersofrome' ? '#0ea5e9' : '#047857';
    ...
    doc.text(data.siteName === 'wondersofrome' ? 'Wonders of Rome' : 'ticketsinrome', margin, 30);
    ...
    doc.text(`Booked via ${data.siteName === 'wondersofrome' ? 'wondersofrome.com' : 'ticketsinrome.com'}`, margin, 295);
