...
export default function WhatsAppButton() {
  const site = useSite();
  const phone   = site?.whatsappNumber || process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '3514199425';
  ...
  return (
    ...
    >
      ...
      {/* Button */}
      <div className="relative w-13 h-13 w-[52px] h-[52px] bg-[#25D366] rounded-2xl flex items-center justify-center shadow-xl shadow-green-500/30 hover:scale-110 active:scale-95 transition-transform duration-200">
