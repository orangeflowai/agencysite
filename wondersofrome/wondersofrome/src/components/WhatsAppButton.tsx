...
export default function WhatsAppButton() {
    const site = useSite();
    const phoneNumber = (site as any)?.whatsappNumber || '3517869798';
    ...
    return (
        ...
        >
            ...
            {/* Button with pulse */}
            <div className="relative w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl shadow-green-500/40 hover:scale-110 active:scale-95 transition-transform duration-200">
