  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        {/* Top badge */}
        <div className="absolute top-3 left-3 bg-primary text-white text-[9px] font-black px-2 py-1 uppercase tracking-[0.2em] rounded-sm shadow-md border border-white/20">
          {topBadgeText}
        </div>
      </div>
      ...
      <div className="w-full py-1.5 bg-foreground text-center relative z-10 -mt-1">
        <span className="text-background text-[9px] font-black uppercase tracking-[0.3em]">
          {middleBarText}
        </span>
      </div>
      ...
      <div className="p-6 flex flex-col grow space-y-4">
        <div className="min-h-[3.5rem]">
          <h3 className="text-lg font-serif font-black text-foreground leading-tight line-clamp-2 uppercase tracking-tight">
            {tour.title}
          </h3>
        </div>

        <div className="flex items-center text-muted-foreground text-xs font-black uppercase tracking-widest h-5">
        ...
        <div className="mt-auto flex items-center justify-between pt-4 border-t border-border/50">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-xs font-black text-foreground">{tour.rating || '5.0'}</span>
          </div>
          <span className="text-[9px] text-muted-foreground font-black tracking-widest uppercase opacity-60">
      ...
      <div className="flex h-16 mt-auto border-t border-border">
        <div className="w-[60%] bg-card text-foreground flex flex-col justify-center px-6 relative overflow-hidden group-hover:bg-accent transition-colors">
          <span className="text-[8px] uppercase opacity-60 font-black tracking-widest mb-0.5">ESTIMATED_COST</span>
          <span className="text-2xl font-serif font-black tracking-tighter italic">€{displayPrice}</span>
        </div>
        <div className="w-[40%] bg-primary text-white flex items-center justify-center font-black text-[10px] uppercase tracking-[0.2em] hover:brightness-110 transition-all cursor-pointer text-center px-4 leading-tight">
          INITIATE
        </div>
      </div>
    </Link>
