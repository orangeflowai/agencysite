                ...
                >
                    <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-2xl border border-gray-100 p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center gap-6">
                        ...
                        <div className="flex gap-3 shrink-0 w-full md:w-auto">
                            ...
                            <button
                                onClick={accept}
                                className="flex-1 md:flex-none px-8 py-3 rounded-xl bg-sky-800 text-white font-bold hover:bg-sky-900 transition-colors shadow-lg shadow-sky-900/10 text-sm"
                            >
                                {acceptButtonText}
                            </button>
                        </div>
