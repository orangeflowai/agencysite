...
export default function Footer() {
    ...
    const siteTitle = site?.title || 'Wonders of Rome';
    ...
    const companyName = businessInfo?.companyName || site?.title || 'Wonders of Rome';
    ...
    // Contact info
    const contactEmail = site?.contactEmail || 'info@wondersofrome.com';
    const contactPhone = site?.contactPhone || '3514199425';
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
                                ...
                                <div className="flex items-center space-x-3">
                                    {socialLinks?.facebook && (
                                        <a
                                            ...
                                            aria-label="Facebook"
                                            className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-500 hover:bg-sky-600 hover:text-gray-900 transition-all duration-300"
                                        >
                                            <Facebook size={18} />
                                        </a>
                                    )}
                                    ...
                                    {!hasSocialLinks && !site && (
                                        <>
                                            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-500 hover:bg-sky-600 hover:text-gray-900 transition-all duration-300">
                                                <Facebook size={18} />
                                            </a>
                                            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-500 hover:bg-sky-600 hover:text-gray-900 transition-all duration-300">
                                                <Instagram size={18} />
                                            </a>
                                            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-500 hover:bg-sky-600 hover:text-gray-900 transition-all duration-300">
                                                <Twitter size={18} />
                                            </a>
                                        </>
                                    )}
                        ...
                        <div>
                            ...
                            {/* Trust Badges — payment logos only, no TripAdvisor */}
                            <div className="mt-6 pt-6 border-t border-gray-100">
                                <p className="text-xs text-gray-400 mb-3 uppercase tracking-wider">Secure Payments</p>
