                ...
                <div className="glass-dark rounded-[4rem] p-10 md:p-24 border border-gold/10 relative group overflow-hidden backdrop-blur-xl bg-white/5">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-20">
                        ...
                        <div className="flex-1 space-y-8 text-center lg:text-left">
                            ...
                            >
                                <span className="font-inter text-[8px] uppercase tracking-[0.4em] text-gold font-bold">Sacred Sanctuary</span>
                            </div>
                        ...
                        <div className="w-full lg:w-2/5">
                                ...
                                {status === 'success' ? (
                                    ...
                                    >
                                        ...
                                        <p className="font-inter text-[8px] uppercase font-bold tracking-[0.2em] text-gold/60">The first Chapter arrives soon.</p>
                                    </div>
                                ) : (
                                    <form
                                        }
                                    ...
                                    >
                                        ...
                                        <button
                                            type="submit"
                                            disabled={status === 'loading'}
                                            className="w-full bg-gold hover:bg-card text-black py-7 rounded-2xl font-bold uppercase tracking-[0.4em] text-[12px] transition-all flex items-center justify-center gap-4 group/btn disabled:opacity-50 shadow-2xl shadow-gold/10"
                                        >
                                            {status === 'loading' ? (
                                        ...
                                        <div className="flex items-center justify-center gap-4 mt-8">
                                            ...
                                            <span className="text-[8px] text-gold/30 uppercase font-black tracking-widest whitespace-nowrap">Sacred Privacy Assured</span>
                                            <div className="h-px flex-1 bg-gold/10"></div>
                                        </div>
                                    </form>
                                )}
