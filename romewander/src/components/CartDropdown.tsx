    ...
    return (
        <div className="relative">
            ...
            >
                ...
                {totalItems > 0 && (
                    <span className="absolute -top-1 -right-1 w-5 h-5 bg-sky-500 text-white text-[8px] font-black rounded-full flex items-center justify-center shadow-lg transform scale-110">
                        {totalItems}
                    </span>
                )}
            </button>
                                            ...
                                            <div className="flex gap-4">
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="flex items-center gap-3 mt-1.5 flex-wrap">
                                                        ...
                                                        <span className="text-[8px] font-bold text-sky-600 uppercase tracking-widest bg-sky-50 px-1.5 py-0.5 rounded">
                                                            {item.time}
                                                        </span>
                                                    </div>
                                                        ...
                                                        {Object.entries(item.guestCounts).map(([type, count]) => {
                                                            ...
                                                            return (
                                                                <div key={type} className="flex items-center justify-between text-xs">
                                                                    <span className="text-gray-500 font-bold uppercase tracking-widest text-[8px]">{type}</span>
                                                    ...
                                                    <div className="mt-4 pt-4 border-t border-gray-100 flex items-center justify-between">
                                                        <span className="text-[8px] font-black text-gray-400 uppercase tracking-widest">Item Total</span>
                                ...
                                <div className="p-6 bg-gray-950">
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="flex flex-col">
                                            <span className="text-[8px] font-black text-gray-400 uppercase tracking-widest mb-0.5">Total Amount</span>
