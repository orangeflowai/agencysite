    ...
    return (
        <div className="min-h-screen bg-muted py-12 px-4">
            ...
            <div className="max-w-3xl mx-auto">
                    ...
                    <div className="p-8">
                        {booking ? (
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        {tour?.meetingPoint && (
                                            <div className="flex justify-between items-start">
                                                ...
                                                <span className="font-semibold text-foreground text-right text-sm max-w-[60%]">{tour.meetingPoint}</span>
                                            </div>
                                        )}
                                    </div>
                                </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {booking.guest_details?.guests && (
                                            <div className="mt-4 pt-4 border-t border-border">
                                                <p className="text-xs font-medium text-muted-foreground  mb-2">Registered Guests</p>
                                                <div className="space-y-1">
                                                    {booking.guest_details.guests.slice(0, 5).map((guest: any, i: number) => (
                                                        <p key={i} className="text-sm text-foreground">
                                                            {guest.index || i + 1}. {guest.name} <span className="text-muted-foreground">({guest.type})</span>
                                                        </p>
                                                    ))}
                                                    {booking.guest_details.guests.length > 5 && (
                                                        <p className="text-sm text-muted-foreground">+{booking.guest_details.guests.length - 5} more</p>
                                                    )}
                                                </div>
                                            </div>
                                        )}
                                        ...
                                        <div className="space-y-2">
                                                ...
                                                <div key={i} className="flex justify-between text-sm">
                                                    ...
                                                    <span className="font-medium">
                                                        ...
                                                        {addon.quantity && addon.quantity > 1 && (
                                                            <span className="text-muted-foreground text-xs ml-1">({addon.quantity})</span>
                                                        )}
                                                    </span>
                                                </div>
                                            ))}
                                            {luggageStorage && (
                                                <div className="flex justify-between text-sm">
                                                    <span className="text-foreground">Luggage Storage ({luggageHours} hours)</span>
                            ...
                            <div className="text-center py-8">
                                ...
                                <p className="text-muted-foreground text-lg">Your booking has been confirmed!</p>
                                <p className="text-sm text-muted-foreground mt-2">Check your email for the confirmation details.</p>
                            </div>
                        )}
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            ...
                            <button
                                ...
                                className="flex items-center justify-center gap-2 px-6 py-4 bg-card border-2 border-border text-foreground font-bold rounded-xl hover:bg-muted transition-colors"
                            >
                                <Download size={18} />
                                Save as PDF
                            </button>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">We&apos;ve sent your tickets and meeting instructions to your inbox</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h4 className="font-semibold text-foreground">24-Hour Reminder</h4>
                                <p className="text-sm text-muted-foreground">We&apos;ll send you an SMS reminder with meeting point details</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h4 className="font-semibold text-foreground">Arrive Early</h4>
                                <p className="text-sm text-muted-foreground">Meet your guide 20 minutes before departure time</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {/* Explore More Tours */}
                <div className="text-center">
                    <p className="text-muted-foreground mb-4">Explore more amazing Rome experiences</p>
                    <Link 
                        href="/tours"
