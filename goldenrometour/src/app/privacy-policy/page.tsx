        ...
        <main className="min-h-screen bg-cream selection:bg-olive selection:text-white">
            ...
            <div className="container mx-auto px-4 py-24 max-w-4xl">
                ...
                <div className="prose prose-lg prose-emerald text-muted-foreground max-w-none space-y-8">
                    ...
                    <p>Please write an email to <a href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL || "goldenrometours@gmail.com"}`} className="text-emerald-700 font-bold hover:underline">{process.env.NEXT_PUBLIC_CONTACT_EMAIL || "goldenrometours@gmail.com"}</a> with your name, email address, and phone number to request removal. We will require identity verification before processing the request.</p>
                    ...
                    <p>If you wish to modify, correct, or delete your personal information, please contact us at <a href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL || "goldenrometours@gmail.com"}`} className="text-emerald-700 font-bold hover:underline">{process.env.NEXT_PUBLIC_CONTACT_EMAIL || "goldenrometours@gmail.com"}</a>.</p>
