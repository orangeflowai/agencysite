    ...
    return (
        <main className="min-h-screen bg-cream selection:bg-olive selection:text-white">
            ...
            <div className="container mx-auto px-4 py-24 max-w-4xl">
                <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-8 tracking-tight text-center">CANCELLATION & REFUND POLICY</h1>
                ...
                <div className="prose prose-lg prose-emerald text-muted-foreground max-w-none space-y-8">
                    ...
                    <h3 className="text-2xl font-bold text-foreground mt-12">1. Booking Options at Checkout</h3>
                    ...
                    <h3 className="text-2xl font-bold text-foreground mt-12">2. General Cancellation Rules</h3>
                    <p>
                        All cancellation requests must be submitted in writing via email to <a href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL || "goldenrometours@gmail.com"}`} className="text-emerald-700 font-bold hover:underline">{process.env.NEXT_PUBLIC_CONTACT_EMAIL || "goldenrometours@gmail.com"}</a> or by contacting our customer service at <a href={`tel:${process.env.NEXT_PUBLIC_SUPPORT_PHONE || "+393802644344"}`} className="text-emerald-700 font-bold hover:underline">+39 380 264 4344</a>. The timing is calculated in Rome local time (CET/CEST).
                    </p>

                    <h3 className="text-2xl font-bold text-foreground mt-12">3. Refund Eligibility Tiers</h3>
                        ...
                        <table className="min-w-full bg-card text-left text-sm md:text-base">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                <tr className="hover:bg-muted transition-colors">
                                    <td className="py-4 px-6 font-medium text-foreground">More than 6 working days before the tour</td>
                                    <td className="py-4 px-6 text-emerald-700 font-bold">100% Refund (minus non-refundable fees)</td>
                                </tr>
                                <tr className="hover:bg-muted transition-colors">
                                    <td className="py-4 px-6 font-medium text-foreground">3 to 6 days before the tour</td>
                                    <td className="py-4 px-6 text-yellow-600 font-bold">50% Refund</td>
                                </tr>
                                <tr className="hover:bg-muted transition-colors">
                                    <td className="py-4 px-6 font-medium text-foreground">Less than 72 hours before the tour</td>
                                    <td className="py-4 px-6 text-red-600 font-bold">No Refund (0%)</td>
                                </tr>
                                <tr className="hover:bg-muted transition-colors">
                                    <td className="py-4 px-6 font-medium text-foreground">No-Show on the day of the tour</td>
                                    <td className="py-4 px-6 text-red-600 font-bold">No Refund (0%)</td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <h3 className="text-2xl font-bold text-foreground mt-12">4. Last-Minute Bookings & Non-Refundable Tours</h3>
                    ...
                    <h3 className="text-2xl font-bold text-foreground mt-12">5. No Refunds Once Tour Has Started</h3>
                    <p>No refunds or credits will be issued once the tour has commenced, regardless of the reason.</p>

                    <h3 className="text-2xl font-bold text-foreground mt-12">6. Rescheduling</h3>
                    <ul className="list-disc pl-5 space-y-2">
                    ...
                    <h3 className="text-2xl font-bold text-foreground mt-12">7. Cancellations by {process.env.NEXT_PUBLIC_SITE_NAME || "Your Agency"}</h3>
                    ...
                    <h3 className="text-2xl font-bold text-foreground mt-12">8. Late Arrivals</h3>
                    ...
                    <h3 className="text-2xl font-bold text-foreground mt-12">9. Travel Insurance Recommendation</h3>
                    ...
                    <h3 className="text-2xl font-bold text-foreground mt-12">10. Processing of Refunds</h3>
                    <p>Approved refunds are processed back to the original payment method within <strong>5–10 business days</strong>.</p>

                    <h3 className="text-2xl font-bold text-foreground mt-12">11. Contact Us</h3>
                    <p>For any questions:</p>
                    <ul className="list-none pl-0 space-y-2">
                        <li><strong>Business name:</strong> Golden Rome Tours</li>
                        <li><strong>Registered in:</strong> Italian Business Register, Italian Chambers of Commerce</li>
                        <li><strong>Registration number:</strong> 17958971008</li>
                        <li><strong>Address:</strong> Via Germanico 26, 00166 Roma RM, Italy</li>
                        <li><strong>Email:</strong> <a href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL || "goldenrometours@gmail.com"}`} className="text-emerald-700 font-bold hover:underline">{process.env.NEXT_PUBLIC_CONTACT_EMAIL || "goldenrometours@gmail.com"}</a></li>
                        <li><strong>Phone/WhatsApp:</strong> <a href={`tel:${process.env.NEXT_PUBLIC_SUPPORT_PHONE || "+393802644344"}`} className="text-emerald-700 font-bold hover:underline">+39 380 264 4344</a></li>
                    </ul>

                    <p className="mt-12 text-center font-bold text-foreground">
