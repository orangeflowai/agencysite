        ...
        <header className={cn(
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="hidden lg:flex items-center gap-2 text-zinc-400 bg-zinc-100/50 px-3 py-1.5 rounded-full border border-zinc-200/50 cursor-pointer hover:bg-zinc-100 transition-colors">
                    ...
                    <span className="text-[8px] bg-card border border-zinc-200 px-1.5 rounded ml-2">⌘K</span>
                </div>
            </div>

            <div className="flex items-center gap-3 lg:gap-6">
                <button className="relative p-2 text-zinc-500 hover:text-black hover:bg-zinc-100 rounded-full transition-all">
                    <Bell size={20} />
                ...
                <div className="flex items-center gap-3 pl-2 group cursor-pointer">
                    <div className="text-right hidden sm:block">
                        <p className="text-xs font-bold text-black group-hover:text-primary transition-colors">Admin User</p>
...
export default function AdminLayoutClient({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="min-h-screen bg-card flex font-body">
            {/* Desktop Sidebar */}
