                                ...
                                >
                                    <div className="flex items-start gap-6">
                                        <div className={clsx(
                                            ...
                                            isOpen ? "bg-forest text-cream" : "bg-forest/5 text-secondary/40"
                                        )}>
                                            <HelpCircle size={14} />
                                        </div>
                                        <span className={clsx(
                                            "font-heading text-lg md:text-2xl font-bold  transition-colors pr-8 leading-tight",
                                    ...
                                    <div className={clsx(
                                        ...
                                        isOpen ? "bg-forest text-cream border-forest rotate-180" : "bg-transparent text-secondary/30 border-forest/10"
                                    )}>
