        ...
        <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto px-6 text-center space-y-12">
                <motion.div
                    ...
                    className="space-y-6"
                >
                    <p className="text-primary font-heading font-bold uppercase tracking-tight text-[10px]">✦ Your Sacred Journey Awaits ✦</p>
                ...
                >
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <p className="text-white/50 font-heading text-[10px] font-bold tracking-tight uppercase">Verified Pilgrims</p>
                    </div>
                    <div className="flex flex-col items-center gap-2">
                        <MapPin className="text-primary w-6 h-6" />
                        <p className="text-white font-heading text-2xl md:text-3xl font-bold">48</p>
                        <p className="text-white/50 font-heading text-[10px] font-bold tracking-tight uppercase">Curated Routes</p>
                    </div>
                    <div className="flex flex-col items-center gap-2">
                        <Star className="text-primary w-6 h-6" />
                        <p className="text-white font-heading text-2xl md:text-3xl font-bold">4.9/5</p>
                        <p className="text-white/50 font-heading text-[10px] font-bold tracking-tight uppercase">Sacred Rating</p>
                    </div>
                </motion.div>
                ...
                >
                    <Link href="/search" className="inline-flex items-center gap-4 bg-primary text-secondary px-16 py-6 font-heading font-bold tracking-tight text-[10px] hover:bg-white transition-all rounded-full shadow-2xl uppercase">
