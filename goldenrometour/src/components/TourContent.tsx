            ...
            <div className="relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12 container mx-auto pointer-events-none z-10">
                    <div className="max-w-4xl space-y-4 pointer-events-auto">
                        <span className="bg-forest text-cream px-4 py-1.5 text-[10px] font-bold  tracking-[0.3em]">
                            {translatedTour.category}
                        </span>
                        <h1 className="font-serif text-4xl md:text-6xl lg:text-8xl font-bold text-white drop-shadow-2xl  leading-[0.9]">
                        ...
                        {translatedTour.rating && (
                            <div className="flex items-center gap-2 text-white drop-shadow-md">
                                <div className="flex items-center gap-1 bg-card/10 backdrop-blur-md px-3 py-1.5 border border-white/20">
                                    <Star className="w-3 h-3 fill-gold text-gold" />
                                    <span className="font-serif  font-bold">{translatedTour.rating}</span>
                                </div>
                                <span className="font-sans text-[10px] font-bold  tracking-widest opacity-80">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="flex flex-wrap gap-4">
                            {translatedTour.duration && (
                                <div className="flex items-center gap-2 text-forest">
                                    ...
                                    <span className="font-sans text-[11px] font-bold  tracking-widest">{translatedTour.duration}</span>
                                </div>
                            )}
                            {translatedTour.groupSize && (
                                <div className="flex items-center gap-2 text-forest">
                                    <Users className="w-4 h-4 text-forest" />
                                    <span className="font-sans text-[11px] font-bold  tracking-widest">{translatedTour.groupSize}</span>
                                </div>
                            )}
                            {translatedTour.location && (
                                <div className="flex items-center gap-2 text-forest">
                                    <MapPin className="w-4 h-4 text-forest" />
                                    <span className="font-sans text-[11px] font-bold  tracking-widest">{translatedTour.location}</span>
                                </div>
                            )}
                        </div>
                        ...
                        {translatedTour.description && (
                            <section>
                                <h2 className="font-serif text-2xl font-bold text-forest mb-6  underline decoration-forest/10">{t('tour.overview')}</h2>
                        ...
                        {translatedTour.excludes && translatedTour.excludes.length > 0 && (
                            <section>
                                <h2 className="font-serif text-2xl font-bold text-forest mb-6  border-b border-forest/10 pb-4">{t('tour.excludes')}</h2>
                        ...
                        {translatedTour.meetingPoint && (
                            <section>
                                <h2 className="font-serif text-2xl font-bold text-forest mb-6  border-b border-forest/10 pb-4">{t('tour.meeting')}</h2>
                                <div className="bg-cream p-8 border border-forest/20 flex flex-col md:flex-row md:items-center justify-between gap-8 mb-8 shadow-xl">
                                    <div className="flex items-start gap-6">
                                        ...
                                        <div>
                                            <p className="text-forest font-serif font-bold  text-lg leading-tight mb-2">{translatedTour.meetingPoint}</p>
                                            <p className="text-[10px] text-forest/40  tracking-[0.2em] font-bold">Please arrive 15 min early for check-in</p>
                                        </div>
                                    </div>
                                    <a
                                        ...
                                        className="bg-forest text-cream px-10 py-4 font-bold text-[10px]  tracking-[0.3em] hover:bg-forest-light transition-all shrink-0 text-center shadow-lg shadow-forest/20"
                                    >
                                        Dispatch Location
                                    </a>
                                </div>
