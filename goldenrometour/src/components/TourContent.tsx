                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        {translatedTour.description && (
                            <section>
                                <h2 className="font-heading text-2xl font-bold text-secondary mb-6  underline decoration-primary/10">{t('tour.overview')}</h2>
                                <div className="font-body prose prose-lg max-w-none text-secondary/80">
                        ...
                        {translatedTour.excludes && translatedTour.excludes.length > 0 && (
                            <section>
                                <h2 className="font-heading text-2xl font-bold text-secondary mb-6  border-b border-forest/10 pb-4">{t('tour.excludes')}</h2>
                                <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {translatedTour.excludes.map((item, idx) => (
                                        <li key={idx} className="flex items-start gap-3">
                                            <XCircle className="w-4 h-4 text-red-800 mt-0.5 shrink-0" />
                                            <span className="text-secondary/70 font-body text-sm">{item}</span>
                                        </li>
                                    ))}
                                </ul>
                            </section>
                        ...
                        {translatedTour.meetingPoint && (
                            <section>
                                <h2 className="font-heading text-2xl font-bold text-secondary mb-6  border-b border-forest/10 pb-4">{t('tour.meeting')}</h2>
