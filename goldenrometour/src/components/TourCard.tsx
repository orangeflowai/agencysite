        ...
        <div className="h-full px-2 py-4">
            ...
            >
                ...
                <div
                    ...
                    style={{ boxShadow: '0 20px 60px rgba(201,168,76,0.12), 0 0 0 1px rgba(201,168,76,0.1) inset' }}
                />
                ...
                <div className="p-6 flex flex-col grow">
                    ...
                    <h3 className="font-serif text-xl font-bold leading-tight mb-4 text-[#1A1210] group-hover:text-[#555B02] transition-colors duration-300 line-clamp-2">
                        {tour.title}
                    </h3>
