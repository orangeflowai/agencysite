...
export default function WhatsAppButton() {
    ...
    return (
        <Link
            ...
            className="fixed bottom-8 right-8 z-50 w-14 h-14 bg-[#25D366] hover:bg-forest text-white shadow-xl transition-all duration-300 hover:scale-105 flex items-center justify-center group overflow-hidden border border-white/20"
