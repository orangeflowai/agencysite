        ...
        <main className="min-h-screen bg-cream selection:bg-olive selection:text-white">
            ...
            <div className="container mx-auto px-4 py-24 max-w-4xl">
                ...
                <div className="prose prose-lg prose-emerald text-muted-foreground max-w-none space-y-8">
                    ...
                    <h3 id="deletion" className="text-2xl font-bold text-foreground mt-12">10. Can I delete my Personal Data from {process.env.NEXT_PUBLIC_SITE_NAME || "Your Agency"}?</h3>
                    <p>Please write an email to <a href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL || "info@romanvaticantour.com"}`} className="text-emerald-700 font-bold hover:underline">{process.env.NEXT_PUBLIC_CONTACT_EMAIL || "info@romanvaticantour.com"}</a> with your name, email address, and phone number to request removal. We will require identity verification before processing the request.</p>
                    ...
                    <p>If you wish to modify, correct, or delete your personal information, please contact us at <a href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL || "info@romanvaticantour.com"}`} className="text-emerald-700 font-bold hover:underline">{process.env.NEXT_PUBLIC_CONTACT_EMAIL || "info@romanvaticantour.com"}</a>.</p>
                    <p>For our full contact info, visit: <a href="/contact" className="text-emerald-700 font-bold hover:underline">{process.env.NEXT_PUBLIC_SITE_URL || "https://romanvaticantour.com"}/contact/</a></p>
                </div>
            </div>
