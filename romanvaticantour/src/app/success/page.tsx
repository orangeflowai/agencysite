                    ...
                    <div className="p-8">
                                ...
                                <div className="bg-muted rounded-xl p-6 mb-6">
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-medium text-foreground text-right">{booking.tour_title}</span>
                                        </div>
                                        <div className="flex justify-between">
                                    ...
                                    <div className="space-y-2">
                                        {(booking as any).guest_details?.guestCounts ? (
                                            ...
                                            <>
                                                ...
                                                {booking.youths > 0 && (
                                                    <div className="flex justify-between text-sm">
                                                        <span className="text-muted-foreground">Youths</span>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            ...
                            <button
                                ...
                                className="flex items-center justify-center gap-2 px-6 py-3 bg-card border-2 border-border text-foreground font-bold rounded-xl hover:bg-muted transition-colors"
                            >
                                <Download size={18} />
                                Save PDF
                            </button>
