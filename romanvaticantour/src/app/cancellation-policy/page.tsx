        ...
        <main className="min-h-screen bg-cream selection:bg-olive selection:text-white">
            ...
            <div className="container mx-auto px-4 py-24 max-w-4xl">
                ...
                <div className="prose prose-lg prose-emerald text-muted-foreground max-w-none space-y-8">
                    ...
                    <p>
                        All cancellation requests must be submitted in writing via email to <a href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL || "info@romanvaticantour.com"}`} className="text-emerald-700 font-bold hover:underline">{process.env.NEXT_PUBLIC_CONTACT_EMAIL || "info@romanvaticantour.com"}</a> or by contacting our customer service at <a href={`tel:${process.env.NEXT_PUBLIC_SUPPORT_PHONE || ""}`} className="text-emerald-700 font-bold hover:underline">{process.env.NEXT_PUBLIC_SUPPORT_PHONE || "+39 389 521 7315"}</a>. The timing is calculated in Rome local time (CET/CEST).
                    </p>
                    ...
                    <ul className="list-none pl-0 space-y-2">
                        ...
                        <li><strong>Phone/WhatsApp:</strong> <a href={`tel:${process.env.NEXT_PUBLIC_SUPPORT_PHONE || ""}`} className="text-emerald-700 font-bold hover:underline">{process.env.NEXT_PUBLIC_SUPPORT_PHONE || "+39 389 521 7315"}</a></li>
                    </ul>
