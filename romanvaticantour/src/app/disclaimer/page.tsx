        ...
        <main className="min-h-screen bg-cream selection:bg-olive selection:text-white">
            ...
            <div className="container mx-auto px-4 py-24 max-w-4xl">
                ...
                <div className="prose prose-lg prose-emerald text-muted-foreground max-w-none space-y-8">
                    ...
                    <p>
                        If you require any more information or have any questions about our site's disclaimer, please feel free to contact us by email at <a href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL || "info@romanvaticantour.com"}`} className="text-emerald-700 font-bold hover:underline">{process.env.NEXT_PUBLIC_CONTACT_EMAIL || "info@romanvaticantour.com"}</a>.
                    </p>
                </div>
            </div>
