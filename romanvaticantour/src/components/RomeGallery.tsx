...
const images = [
  { src: `${R2}/pexels-axp-photography-500641970-18991563.jpg`,  alt: 'Colosseum, Rome' },
  { src: `${R2}/pexels-akarsh-chandran-2156074716-34026966.jpg`, alt: "St Peter's Basilica, Vatican" },
  { src: `${R2}/pexels-alex-250137-757239.jpg`,                  alt: 'Trevi Fountain, Rome' },
  { src: `${R2}/pexels-efrem-efre-2786187-17282659.jpg`,         alt: 'Roman Forum, Rome' },
  { src: `${R2}/pexels-filiamariss-30785778.jpg`,                alt: 'Pantheon, Rome' },
  { src: `${R2}/pexels-giorgi-gobadze-2160475859-36770779.jpg`,  alt: 'Spanish Steps, Rome' },
];
