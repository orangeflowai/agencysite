    ...
    if (variant === 'wave') {
        return (
            <div className={`w-full overflow-hidden leading-none rotate-180 ${position === 'top' ? 'rotate-0' : ''}`}>
                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className={`relative block w-full h-[64px] lg:h-[96px] ${color} fill-current`}>
    ...
    if (variant === 'slope') {
        return (
            <div className={`w-full overflow-hidden leading-none transform ${position === 'top' ? 'rotate-180' : ''}`}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className={`relative block w-full h-[48px] lg:h-[80px] ${color} fill-current`}>
