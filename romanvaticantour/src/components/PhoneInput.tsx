                                ...
                                <div className="absolute top-full left-0 mt-1 w-64 max-h-64 overflow-y-auto bg-card border border-border rounded-lg shadow-xl z-50">
                                    {countries.map((country) => (
                                        <button
                                            ...
                                            className={`w-full px-4 py-2 flex items-center gap-3 hover:bg-muted transition-colors text-left ${selectedCountry.code === country.code ? 'bg-sky-50 text-sky-700' : ''
                                                }`}
                                        >
