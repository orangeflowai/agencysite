...
// R2 videos — use the best available
const R2_VIDEOS = [
...
export default function Hero({ settings }: HeroProps) {
  ...
  // Use settings video if available, otherwise first R2 video
    ...
    <section className="relative min-h-screen w-full flex items-center overflow-hidden bg-neutral-950">
      ...
      <div className="absolute inset-0 z-0">
        ...
        >
          ...
          {/* Fallback to other R2 videos */}
          <source src={R2_VIDEOS[1]} type="video/mp4" />
          <source src={R2_VIDEOS[2]} type="video/mp4" />
        </video>
      ...
      <div className="relative z-10 container mx-auto px-6 md:px-12 py-32 md:py-40">
        <div className="max-w-3xl space-y-8">
          ...
          {/* Headline */}
          <h1 className="text-5xl md:text-7xl lg:text-[5.5rem] font-serif font-bold tracking-tight text-white leading-[1.05]">
            {settings?.heroTitle || (
              <>
                The Vatican.<br />
                <span className="text-accent italic font-serif">Skip the line,</span><br />
                own the moment.
              </>
            )}
          </h1>
          ...
          {/* Subtitle */}
          <p className="text-lg md:text-xl text-white/75 max-w-xl leading-relaxed font-sans">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              href="/search"
              className="group inline-flex items-center justify-center gap-2 px-8 py-4 text-sm font-bold uppercase tracking-widest text-white rounded-xl transition-all hover:scale-105 hover:shadow-2xl bg-primary"
            >
              Browse All Tours
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                className="shrink-0 px-6 py-3 rounded-xl font-bold text-sm text-white transition-all hover:scale-105 active:scale-95 shadow-lg bg-primary border border-primary/50"
              >
                Search
              </button>
            </div>
