...
const faqCategories = [
    {
        ...
        items: [
            {
                question: "How do I book a tour with Tickets in Rome?",
                answer: "You can book directly through our website at ticketsinrome.com. Simply select your tour, choose a date and time, and follow the checkout process."
            },
            {
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                answer: "We’ll do our best to help! Please contact us at info@ticketsinrome.com at least 72 hours before your tour. Changes are subject to ticket availability and site capacity."
            },
            {
            ...
            <div className="container mx-auto px-4 py-20 max-w-4xl">
                            ...
                            <div className="space-y-4">
                                {category.items.map((item, index) => {
                                    ...
                                    return (
                                        <div
                                            key={index}
                                            className="bg-card rounded-xl border border-gray-100 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300"
                                        >
                                            <button
                                                onClick={() => toggle(id)}
                ...
                <div className="mt-20 bg-emerald-50 rounded-2xl p-8 md:p-12 text-center border border-emerald-100">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                        <a href="mailto:info@ticketsinrome.com" className="flex items-center gap-2 px-6 py-3 bg-card text-emerald-800 font-bold rounded-lg border border-emerald-200 hover:border-emerald-400 shadow-sm transition-all hover:-translate-y-1">
                            <Mail size={18} />
                            info@ticketsinrome.com
                        </a>
