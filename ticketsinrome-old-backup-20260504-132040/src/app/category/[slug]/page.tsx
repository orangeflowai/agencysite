...
const categoryMap: Record<string, { title: string; subtitle: string; images: string[] }> = {
    'vatican': {
        ...
        images: [
            'https://ogrvhooygcoazracbvkb.supabase.co/storage/v1/object/public/images/05487657941d3eb0676bbf6ab64bbad7.jpg',
    ...
    'colosseum': {
        ...
        images: [
            'https://ogrvhooygcoazracbvkb.supabase.co/storage/v1/object/public/images/54d70ba36759f71567f18e252ff1959c.jpg',
    ...
    'hidden-gems': {
        ...
        images: [
            ...
            'https://ogrvhooygcoazracbvkb.supabase.co/storage/v1/object/public/images/f86b196f-a022-4f5b-9684-63979caa26af.jpg',
            'https://ogrvhooygcoazracbvkb.supabase.co/storage/v1/object/public/images/e5b1479b445c00ff11bbad9415d42a31.jpg'
        ]
    }
};
        ...
        <main className="min-h-screen bg-[#FDFFF5]">
            ...
            <div className="container mx-auto px-4 py-20">
                ...
                {filteredTours.length > 0 ? (
                    ...
                    <div className="text-center py-20 bg-card rounded-3xl shadow-sm border border-gray-100">
