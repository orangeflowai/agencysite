...
function NavLink({ href, icon: Icon, children, external, onClick }: NavLinkProps) {
    return (
        <Link
            href={href}
            onClick={onClick}
            className="flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-gray-600 rounded-lg hover:bg-muted hover:text-foreground transition-all group"
    ...
    return (
        <>
            ...
            <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                <a href="/studio" target="_blank" className="flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-gray-600 rounded-lg hover:bg-muted hover:text-foreground transition-all group">
