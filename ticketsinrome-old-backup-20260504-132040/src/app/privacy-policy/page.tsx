        ...
        <main className="min-h-screen bg-cream selection:bg-olive selection:text-white">
            ...
            <div className="container mx-auto px-4 py-24 max-w-4xl">
                ...
                <div className="prose prose-lg prose-emerald text-gray-600 max-w-none space-y-8">
                    ...
                    <div className="bg-card p-8 rounded-xl border border-gray-100 shadow-sm my-8">
                    ...
                    <h3 id="deletion" className="text-2xl font-bold text-foreground mt-12">10. Can I delete my Personal Data from Tickets in Rome?</h3>
