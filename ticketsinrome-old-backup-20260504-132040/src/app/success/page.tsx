...
function SuccessContent() {
    ...
    async function fetchTourDetails(slug: string) {
        try {
            // This would fetch from Sanity, but we'll use placeholder for now
            setTour({
    ...
    const calculateDiscountCode = () => {
        ...
        return `ROME${booking.id.slice(-6).toUpperCase()}`;
    };
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-card rounded-2xl shadow-xl border border-border overflow-hidden mb-6">
                    <div className="bg-gradient-to-r from-emerald-600 to-teal-600 p-8 text-center">
                        ...
                        <p className="text-emerald-100">Grazie! Your Rome adventure awaits</p>
                    </div>
                    ...
                    <div className="p-8">
                            ...
                            <>
                                ...
                                <div className="bg-muted rounded-xl p-6 mb-6">
                                    ...
                                    <div className="space-y-2">
                                        {/* Dynamic Guests from guest_details */}
                                        {booking.guest_details?.guestCounts ? (
                                            Object.entries(booking.guest_details.guestCounts).map(([type, count]) => (
                                                (count as number) > 0 && (
                                                    <div key={type} className="flex justify-between items-center">
                                                        <span className="text-gray-600 flex items-center gap-2 capitalize">
                                                ...
                                                <div className="space-y-1">
                                                    {booking.guest_details.guests.slice(0, 5).map((guest: any, i: number) => (
                                                        <p key={i} className="text-sm text-gray-700">
                                                            {guest.index}. {guest.name} <span className="text-muted-foreground">({guest.type})</span>
                                                        </p>
                                                    ))}
                                ...
                                {booking.add_ons && booking.add_ons.length > 0 && (
                                    <div className="bg-amber-50 rounded-xl p-6 mb-6 border border-amber-100">
                                        ...
                                        <div className="space-y-2">
                                            {booking.add_ons.map((addon: any, i: number) => (
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            ...
                            <button
                                ...
                                className="flex items-center justify-center gap-2 px-6 py-4 bg-card border-2 border-border text-gray-700 font-bold rounded-xl hover:bg-muted transition-colors"
                            >
                                <Download size={18} />
                                Save as PDF
                            </button>
