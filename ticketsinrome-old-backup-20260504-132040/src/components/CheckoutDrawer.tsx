    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row overflow-y-auto flex-1 min-h-0">
          ...
          <div className="flex-1 p-6 space-y-5">
            ...
            {step === 1 && (
              <>
                ...
                <div className="flex items-start gap-2.5 p-3.5 bg-muted rounded-xl border border-gray-100">
          ...
          {/* Right: Order Summary */}
          <div className="md:w-64 lg:w-72 bg-muted border-t md:border-t-0 md:border-l border-gray-100 p-5 shrink-0">
