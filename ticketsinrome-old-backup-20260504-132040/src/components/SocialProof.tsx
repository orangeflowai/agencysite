            ...
            <div className="relative w-full overflow-hidden">
                ...
                >
                    ...
                    {[...reviews, ...reviews].map((review, i) => (
                        <div key={i} className="w-[350px] bg-card/10 backdrop-blur-md border border-white/10 p-6 rounded-2xl flex-shrink-0 hover:bg-card/15 transition-colors cursor-pointer relative group">
