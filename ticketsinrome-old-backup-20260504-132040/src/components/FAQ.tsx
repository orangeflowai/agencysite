...
export default function FAQ() {
    ...
    return (
        <section className="py-24 bg-card relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 bg-emerald-50 rounded-full opacity-50 blur-3xl pointer-events-none" />
                        ...
                        return (
                            <motion.div
                                ...
                                className={clsx(
                                    ...
                                    isOpen
                                        ? "bg-card border-emerald-200 shadow-xl shadow-emerald-900/5"
                                        : "bg-card border-gray-100 hover:border-emerald-200 hover:shadow-lg"
                                )}
                            >
                                <button
                                ...
                                >
                                    <div className="flex items-start gap-5">
                                        ...
                                        <span className={clsx(
                                            ...
                                            isOpen ? "text-emerald-900" : "text-foreground"
                                        )}>
                                            {faq.question}
                                        </span>
                                    </div>
                                    ...
                                    <div className={clsx(
                                        ...
                                        isOpen ? "bg-primary text-white rotate-180" : "bg-muted text-muted-foreground group-hover:bg-emerald-50 group-hover:text-primary"
                                    )}>
