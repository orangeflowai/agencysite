...
export default function InventoryCalendar({ tours }: InventoryCalendarProps) {
    ...
    return (
        <div className="bg-card rounded-2xl shadow-sm border border-border overflow-hidden flex flex-col h-[calc(100vh-140px)]">
            {/* Header / Toolbar */}
            <div className="p-4 border-b border-gray-100 flex items-center justify-between bg-card z-10">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex bg-gray-100 rounded-lg p-1">
                        ...
                        <button onClick={() => setCurrentMonth(new Date())} className="px-3 text-xs font-bold text-gray-600 hover:bg-card rounded-md transition-shadow">
                            Today
                        </button>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <select
                        className="bg-muted border border-border text-sm rounded-lg p-2 font-medium text-gray-700 outline-none focus:ring-2 focus:ring-primary"
