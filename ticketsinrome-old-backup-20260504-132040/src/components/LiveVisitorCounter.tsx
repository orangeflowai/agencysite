...
export default function LiveVisitorCounter() {
  ...
  const baseCount = 923; // Base number of viewers
  ...
  return (
    <motion.div
      ...
      className="inline-flex items-center gap-2 bg-card/90 backdrop-blur-sm px-4 py-2 rounded-full shadow-md border border-gray-100"
    >
      <motion.div
