            ...
            <div className="flex relative w-full">
                ...
                >
                    ...
                    {[...images, ...images, ...images].map((src, i) => (
                        <div key={i} className="relative w-[300px] h-[400px] md:w-[400px] md:h-[500px] flex-shrink-0 rounded-2xl overflow-hidden transition-all duration-500 hover:scale-105">
                            <Image
                                src={src}
                                alt={`Rome Gallery ${i}`}
                                fill
