                        ...
                        <div className="space-y-3">
                            {[
                                ...
                                <label key={i} className="flex items-center justify-between p-3 bg-muted rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                                    ...
                                    <input type="checkbox" defaultChecked={item.checked} className="w-5 h-5 rounded border-gray-300 text-primary focus:ring-emerald-500" />
                                </label>
                            ))}
                        </div>
                    </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-2.5 border border-border rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all"
                                    />
                                </div>
                            </div>
                            <div className="space-y-2">
                            ...
                            <div className="space-y-2 md:col-span-2">
                                ...
                                <div className="relative">
                                    ...
                                    <textarea
                                        ...
                                        rows={3}
                                        className="w-full pl-10 pr-4 py-2.5 border border-border rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all resize-none"
                                    />
                                </div>
                            </div>
                        </div>
                            ...
                            {Object.entries(PRESET_THEMES).map(([key, preset]) => (
                                <button
                                    ...
                                    className={`relative p-4 rounded-xl border-2 transition-all ${!isCustom && theme.name === preset.name
                                        ? 'border-emerald-500 bg-secondary/50'
                        ...
                        <div className="space-y-6">
                            ...
                            <label className="flex items-center justify-between p-4 bg-muted rounded-xl cursor-pointer">
                                ...
                                <input
                                    ...
                                    className="w-6 h-6 rounded border-gray-300 text-primary focus:ring-emerald-500"
                                />
                            </label>
                            ...
                            <div className="space-y-2">
                                ...
                                <select
                                    ...
                                    className="w-full px-4 py-2.5 border border-border rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all bg-card"
                                >
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    rows={3}
                                    className="w-full px-4 py-2.5 border border-border rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all resize-none"
                                />
                            </div>
                ...
                <div className="grid gap-6">
                    ...
                    <div className="bg-card rounded-2xl shadow-sm border border-border p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="flex items-center gap-3 p-4 bg-secondary rounded-xl border border-emerald-100">
