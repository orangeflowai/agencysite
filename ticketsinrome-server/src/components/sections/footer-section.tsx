        ...
        <div className="grid grid-cols-2 gap-12 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-2">
            ...
            <div className="mt-8 space-y-4">
              ...
              <a href="mailto:info@wondersofrome.com" className="flex items-center gap-3 text-sm text-muted-foreground hover:text-foreground transition-colors">
                <div className="w-8 h-8 rounded-full bg-muted flex items-center justify-center">
                  <span className="text-[10px] font-bold">@</span>
                </div>
                <p className="text-xs font-semibold">info@wondersofrome.com</p>
              </a>
      ...
      <div className="border-t border-border px-6 py-6 md:px-12 lg:px-20">
        <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
          ...
          <div className="flex items-center gap-6">
            <a
              href="https://instagram.com/wondersofrome"
              target="_blank"
            ...
            <a
              href="https://facebook.com/wondersofrome"
              target="_blank"
              rel="noopener noreferrer"
              className="text-xs text-muted-foreground transition-colors hover:text-foreground"
            >
            ...
            <a
              href="https://www.tripadvisor.com/Attraction_Review-g187791-d23871465-Reviews-Wonders_of_Rome-Rome_Lazio.html"
              target="_blank"
              rel="noopener noreferrer"
              className="text-xs text-muted-foreground transition-colors hover:text-foreground"
            >
