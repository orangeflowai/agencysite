  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {totalItems > 0 && (
          <span className="absolute -top-0.5 -right-0.5 min-w-[16px] h-[16px] bg-gradient-to-br from-blue-400 to-blue-600 text-white text-[10px] font-bold rounded-full flex items-center justify-center px-1 shadow-lg shadow-blue-500/40 animate-pulse-gold">
            {totalItems}
          </span>
        )}
      </button>
      ...
      {isCartOpen && (
        <div className="absolute right-0 top-full mt-3 w-[416px] z-50 rounded-2xl overflow-hidden shadow-[0_24px_64px_rgba(0,0,0,0.18)] border border-white/60 animate-fade-up">
          ...
          <div className="relative bg-gradient-to-br from-blue-600 via-blue-500 to-teal-500 px-5 py-4 flex items-center justify-between overflow-hidden">
                    ...
                    <div key={item.id} className="px-5 py-4 hover:bg-slate-50/60 transition-colors group">
                      <div className="flex gap-3">
                        ...
                        {item.image ? (
                          ...
                          <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-blue-100 to-teal-100 shrink-0 flex items-center justify-center">
                                ...
                                <div key={type} className="flex items-center justify-between">
                                  ...
                                  <div className="flex items-center gap-2">
                                    <button
                                      ...
                                      disabled={count <= 0}
                                      className="w-6 h-6 rounded-lg border border-slate-200 flex items-center justify-center text-slate-400 hover:border-blue-300 hover:text-primary hover:bg-secondary transition-all disabled:opacity-30"
                                    >
                                      <Minus size={10} />
                                    </button>
                                    ...
                                    <button
                                      onClick={() => adjustGuests(item.id, type, 1)}
                                      className="w-6 h-6 rounded-lg border border-slate-200 flex items-center justify-center text-slate-400 hover:border-blue-300 hover:text-primary hover:bg-secondary transition-all"
                                    >
                                      <Plus size={10} />
                                    </button>
                                  </div>
