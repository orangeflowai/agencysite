...
const badges = [
  { icon: Shield,       title: 'Secure Booking',   subtitle: 'SSL Encrypted',    color: 'from-blue-400 to-blue-600' },
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
        {badges.map((badge, i) => {
          ...
          return (
            <div
              key={badge.title}
              className="bg-card/90 backdrop-blur-sm rounded-2xl p-4 shadow-lg border border-border text-center hover:scale-105 hover:-translate-y-1 transition-all duration-300 cursor-pointer"
            >
