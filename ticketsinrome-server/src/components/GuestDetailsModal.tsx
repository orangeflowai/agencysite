                    ...
                    >
                                            ...
                                            <div className="grid grid-cols-1 gap-4">
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full p-3 bg-card border border-border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                                                    />
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="p-6 border-t border-border bg-muted flex justify-end gap-3 shrink-0">
                            ...
                            <button
                                type="submit"
                                form="guest-form"
                                className="px-8 py-3 bg-primary hover:bg-sky-700 text-white font-bold rounded-xl shadow-lg transition-all"
                            >
                                Confirm & Pay
                            </button>
                        </div>
