            ...
            <div className="bg-card max-w-md w-full rounded-2xl shadow-xl overflow-hidden border border-border">
                <div className="bg-blue-900 p-8 text-center">
                    <div className="mx-auto bg-blue-800 w-16 h-16 rounded-full flex items-center justify-center mb-4">
                        <Lock className="text-blue-100 w-8 h-8" />
                    </div>
                    <h1 className="text-2xl font-bold text-white">Admin Access</h1>
                    <p className="text-blue-200 text-sm mt-2">Sign in to manage tours & inventory</p>
                </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-3 border border-border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
