                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2 border border-border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2 border border-border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none font-mono text-sm"
                        ...
                        >
                            ...
                            <div className="p-4 flex items-center gap-4">
                                ...
                                <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                                    addon.available ? 'bg-blue-100 text-primary' : 'bg-gray-100 text-muted-foreground'
                                }`}>
