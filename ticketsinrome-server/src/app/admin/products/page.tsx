        ...
        <div>
            <div className="flex items-center justify-between mb-8">
                ...
                <Link
                    ...
                    target="_blank"
                    className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-blue-700 bg-secondary hover:bg-blue-100 rounded-lg transition-colors border border-blue-200"
                >
                    <Plus size={16} />
                    New Tour (Sanity)
                </Link>
                    ...
                    <div className="bg-white dark:bg-zinc-900 rounded-2xl w-full max-w-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200 flex flex-col max-h-[90vh] border border-zinc-200 dark:border-zinc-700">
                        ...
                        <div className="flex border-b border-zinc-200 dark:border-zinc-700 px-6 overflow-x-auto bg-white dark:bg-zinc-900">
                            <button
                                ...
                                className={`py-3 px-4 text-sm font-bold border-b-2 transition-colors shrink-0 ${activeTab === 'general' ? 'border-blue-500 text-primary' : 'border-transparent text-muted-foreground hover:text-foreground'}`}
                            >
                                General
                            </button>
                            <button
                                ...
                                className={`py-3 px-4 text-sm font-bold border-b-2 transition-colors shrink-0 ${activeTab === 'pricing' ? 'border-blue-500 text-primary' : 'border-transparent text-muted-foreground hover:text-foreground'}`}
                            >
                                Pricing & Guests
                            </button>
                            <button
                                ...
                                className={`py-3 px-4 text-sm font-bold border-b-2 transition-colors shrink-0 ${activeTab === 'content' ? 'border-blue-500 text-primary' : 'border-transparent text-muted-foreground hover:text-foreground'}`}
                            >
                                Content & Lists
                            </button>
                            <button
                                ...
                                className={`py-3 px-4 text-sm font-bold border-b-2 transition-colors shrink-0 ${activeTab === 'logistics' ? 'border-blue-500 text-primary' : 'border-transparent text-muted-foreground hover:text-foreground'}`}
                            >
                                Logistics
                            </button>
                        </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="col-span-2">
                                            ...
                                            <input
                                                ...
                                                className="w-full p-3 bg-muted border border-border rounded-xl outline-none focus:border-blue-500 font-medium"
                                            />
                                        </div>
                                        <div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-4">
                                                ...
                                                <div className="grid grid-cols-2 gap-4">
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full p-2 bg-card border border-border rounded-lg outline-none focus:border-blue-500 text-sm font-medium"
                                                        />
                                                    </div>
                                                    <div>
                                        ...
                                        <button
                                            ...
                                            className="w-full py-3 border-2 border-dashed border-border rounded-xl text-muted-foreground font-bold text-sm hover:border-blue-200 hover:text-primary hover:bg-secondary transition-all flex items-center justify-center gap-2"
                                        >
                                            <Plus size={16} />
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            rows={5}
                                            className="w-full p-3 bg-muted border border-border rounded-xl outline-none focus:border-blue-500 font-medium text-sm"
                                        />
                                    </div>
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                        ...
                        <div className="p-6 border-t border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 shrink-0">
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    disabled={saving}
                                    className="flex-1 py-3 font-bold text-white bg-primary hover:opacity-90 rounded-xl shadow-lg shadow-blue-200 transition-all active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
                                >
