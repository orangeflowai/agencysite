                            ...
                            <div className="p-5">
                                ...
                                <div className="flex items-center gap-3 mt-auto pt-4 border-t border-border">
                                    <Link
                                        ...
                                        target="_blank"
                                        className="flex-1 flex items-center justify-center gap-2 px-3 py-2 text-sm font-bold text-blue-700 bg-secondary rounded-lg hover:bg-blue-100 transition-colors"
                                    >
                                        <Edit size={14} />
                                        Edit in Studio
                                    </Link>
