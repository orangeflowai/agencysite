                        ...
                        {users.map((user) => (
                            <div key={user.id} className="flex items-center justify-between p-4 hover:bg-muted transition-colors">
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center text-sm font-bold text-primary">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="px-2.5 py-1 bg-secondary text-blue-700 text-xs font-medium rounded-full">
                                        Admin
                                    </span>
                                    <button
