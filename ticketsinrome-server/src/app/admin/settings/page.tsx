...
export default function SettingsPage() {
    ...
    if (!mounted) {
        return <div className="h-96 flex items-center justify-center"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600"></div></div>;
    }
        ...
        <div>
            ...
            <div className="flex items-center gap-3">
                ...
                <button
                    onClick={handleSave}
                    disabled={saving}
                    className="flex items-center gap-2 px-4 py-2 bg-primary text-white font-medium rounded-xl hover:opacity-90 transition-colors disabled:opacity-50"
                >
                    {saving ? (
                        ...
                        <div className="space-y-3">
                            {[
                                ...
                                <label key={i} className="flex items-center justify-between p-3 bg-muted rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                                    ...
                                    <input type="checkbox" defaultChecked={item.checked} className="w-5 h-5 rounded border-gray-300 text-primary focus:ring-blue-500" />
                                </label>
                            ))}
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 border border-border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
                                />
                            </div>
                            <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-2.5 border border-border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
                                    />
                                </div>
                            </div>
                            <div className="space-y-2">
                            ...
                            <div className="space-y-2 md:col-span-2">
                                ...
                                <div className="relative">
                                    ...
                                    <textarea
                                        ...
                                        rows={3}
                                        className="w-full pl-10 pr-4 py-2.5 border border-border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all resize-none"
                                    />
                                </div>
                            </div>
                        </div>
                            ...
                            {Object.entries(PRESET_THEMES).map(([key, preset]) => (
                                <button
                                    ...
                                    className={`relative p-4 rounded-xl border-2 transition-all ${!isCustom && theme.name === preset.name
                                        ? 'border-blue-500 bg-secondary/50'
                        ...
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className="px-4 py-2 bg-primary text-white text-sm font-medium rounded-lg hover:opacity-90 transition-colors"
                                >
                                    Apply Custom
                                </button>
                                <button
                        ...
                        <div className="space-y-6">
                            ...
                            <label className="flex items-center justify-between p-4 bg-muted rounded-xl cursor-pointer">
                                ...
                                <input
                                    ...
                                    className="w-6 h-6 rounded border-gray-300 text-primary focus:ring-blue-500"
                                />
                            </label>
                            ...
                            <div className="space-y-2">
                                ...
                                <select
                                    ...
                                    className="w-full px-4 py-2.5 border border-border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all bg-card"
                                >
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    rows={3}
                                    className="w-full px-4 py-2.5 border border-border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all resize-none"
                                />
                            </div>
                        ...
                        <div className="mt-8 p-4 bg-muted rounded-xl border border-border">
                            ...
                            <div className="bg-card rounded-xl shadow-lg border border-border p-4">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button className="px-4 py-2 rounded-lg bg-blue-800 text-white text-sm font-medium">
                ...
                <div className="grid gap-6">
                    ...
                    <div className="bg-card rounded-2xl shadow-sm border border-border p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="flex items-center gap-3 p-4 bg-secondary rounded-xl border border-blue-100">
                                <div className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center">
                                    <div className="w-4 h-4 bg-primary rounded-full"></div>
                                </div>
                                <div>
                                    <p className="font-semibold text-blue-900">Green</p>
                                    <p className="text-sm text-blue-700">High availability (&gt;10 spots)</p>
                                </div>
                            </div>
