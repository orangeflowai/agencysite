            ...
            <div className="container mx-auto px-4 py-24 max-w-4xl">
                ...
                <div className="prose prose-lg prose-blue text-muted-foreground max-w-none space-y-8">
                    ...
                    <ul className="list-none pl-0 space-y-2">
                        <li><strong>Email:</strong> <a href="mailto:info@wondersofrome.com" className="text-blue-700 font-bold hover:underline">{process.env.NEXT_PUBLIC_CONTACT_EMAIL || "info@romeagency.com"}</a></li>
                        <li><strong>Phone:</strong> <a href="tel:3514199425" className="text-blue-700 font-bold hover:underline">351 419 9425</a></li>
                    </ul>
                </div>
