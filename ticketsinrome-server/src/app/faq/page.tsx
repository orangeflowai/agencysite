        ...
        items: [
            {
                ...
                answer: "You can book directly through our website at wondersofrome.com. Simply select your tour, choose a date and time, and follow the checkout process."
            },
            {
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                answer: "We’ll do our best to help! Please contact us at info@wondersofrome.com at least 72 hours before your tour. Changes are subject to ticket availability and site capacity."
            },
            {
    ...
    return (
        <main className="min-h-screen bg-cream selection:bg-olive selection:text-white">
            ...
            <div className="container mx-auto px-4 py-20 max-w-4xl">
                ...
                {/* Contact Section */}
                <div className="mt-20 bg-secondary rounded-2xl p-8 md:p-12 text-center border border-blue-100">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                        <a href="mailto:info@wondersofrome.com" className="flex items-center gap-2 px-6 py-3 bg-card text-blue-800 font-bold rounded-lg border border-blue-200 hover:border-blue-400 shadow-sm transition-all hover:-translate-y-1">
                            <Mail size={18} />
                            info@wondersofrome.com
                        </a>
                        <a href="tel:+393898922088" className="flex items-center gap-2 px-6 py-3 bg-primary text-white font-bold rounded-lg hover:opacity-90 shadow-lg shadow-blue-200 transition-all hover:-translate-y-1">
                            <Phone size={18} />
