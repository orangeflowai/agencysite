        ...
        <main className="min-h-screen bg-cream selection:bg-olive selection:text-white">
            ...
            <div className="relative h-[40vh] min-h-[400px] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
                    <span className="block text-blue-300 font-bold tracking-widest  mb-4 text-sm md:text-base">
                        Travel Tips & Guides
                    </span>
            ...
            <div className="container mx-auto px-4 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {posts.map((post) => (
                        <Link
                            ...
                            className="group bg-card rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-blue-50 hover:-translate-y-1 flex flex-col"
                        >
                            ...
                            <div className="p-6 flex flex-col flex-1">
                                ...
                                <div className="flex items-center text-blue-700 font-bold text-sm group-hover:translate-x-1 transition-transform mt-auto">
                ...
                {posts.length === 0 && (
                    <div className="text-center py-20 bg-secondary rounded-2xl border border-blue-100">
                        <h3 className="text-2xl font-serif font-bold text-blue-900 mb-2">No Stories Yet</h3>
                        <p className="text-blue-700">Check back soon for our first travel guide!</p>
                    </div>
                )}
            </div>
