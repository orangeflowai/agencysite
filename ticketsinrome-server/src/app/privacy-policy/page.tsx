...
export const metadata: Metadata = {
    title: 'Privacy Policy | Wonders of Rome',
    description: 'Privacy Policy for Wonders of Rome. Learn how we collect, use, and protect your personal information.',
};
    ...
    return (
        <main className="min-h-screen bg-cream selection:bg-olive selection:text-white">
            ...
            <div className="container mx-auto px-4 py-24 max-w-4xl">
                ...
                <div className="prose prose-lg prose-blue text-muted-foreground max-w-none space-y-8">
                    <p className="lead text-xl text-gray-800 font-medium">
                        At Wonders of Rome, we care about the privacy of your data and are committed to protecting it. We will not use or share your information with anyone except as described in this Privacy Policy.
                    </p>

                    <p>
                        We use your Personal Information for providing and improving the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. The privacy policy we share is subject to terms and conditions, available here for review: <a href="/terms-and-conditions" className="text-blue-700 font-bold hover:underline">https://wondersofrome.com/terms-and-conditions/</a>
                    </p>

                    <p>
                        This Privacy Policy explains what information we collect about you and why, what we do with that information, and how we handle that information. Throughout this policy, when we write “Tickets in Rome” or “we” or “us,” we’re referring to Wonders of Rome, and our subsidiaries and other affiliates.
                    </p>

                    <div className="bg-card p-8 rounded-xl border border-border shadow-sm my-8">
                        <h2 className="text-2xl font-bold text-foreground mb-4 mt-0">Table of Contents</h2>
                        <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 list-none p-0">
                            <li><a href="#scope" className="text-primary hover:text-blue-800 font-medium">1. What is the scope of this policy?</a></li>
                            <li><a href="#personal-info" className="text-primary hover:text-blue-800 font-medium">2. Personal Information We Collect</a></li>
                            <li><a href="#other-info" className="text-primary hover:text-blue-800 font-medium">3. Other Information we collect</a></li>
                            <li><a href="#usage" className="text-primary hover:text-blue-800 font-medium">4. How do we use your personal information?</a></li>
                            <li><a href="#disclosure" className="text-primary hover:text-blue-800 font-medium">5. Information Access and Disclosure</a></li>
                            <li><a href="#cookies" className="text-primary hover:text-blue-800 font-medium">6. Cookie Policy</a></li>
                            <li><a href="#widgets" className="text-primary hover:text-blue-800 font-medium">7. Third-Party Widgets</a></li>
                            <li><a href="#pixels" className="text-primary hover:text-blue-800 font-medium">8. Tracking Pixels</a></li>
                            <li><a href="#security" className="text-primary hover:text-blue-800 font-medium">9. Data Storage and Security</a></li>
                            <li><a href="#deletion" className="text-primary hover:text-blue-800 font-medium">10. Can I delete my Personal Data?</a></li>
                            <li><a href="#children" className="text-primary hover:text-blue-800 font-medium">11. Children’s Online Privacy Protection</a></li>
                            <li><a href="#changes" className="text-primary hover:text-blue-800 font-medium">12. Changes to this Privacy Policy</a></li>
                            <li><a href="#contact" className="text-primary hover:text-blue-800 font-medium">13. Contact Information & Feedback</a></li>
                        </ul>
                    </div>

                    <h3 id="scope" className="text-2xl font-bold text-foreground mt-12">1. What is the scope of this policy?</h3>
                    ...
                    <h3 id="personal-info" className="text-2xl font-bold text-foreground mt-12">2. Personal Information We Collect</h3>
                    ...
                    <h3 id="other-info" className="text-2xl font-bold text-foreground mt-12">3. Other Information we collect</h3>
                    <p>We automatically log certain information regarding the devices you use to access Wonders of Rome:</p>
                    <ul className="list-disc pl-5 space-y-1">
                        ...
                        <li><strong>Usage Information:</strong> Information on how you interact with the Wonders of Rome Site and Services.</li>
                    </ul>

                    <h3 id="usage" className="text-2xl font-bold text-foreground mt-12">4. How do we use your personal information?</h3>
                    ...
                    <h3 id="disclosure" className="text-2xl font-bold text-foreground mt-12">5. Information Access and Disclosure</h3>
                    ...
                    <h3 id="cookies" className="text-2xl font-bold text-foreground mt-12">6. Cookie Policy</h3>
                    ...
                    <p><em>Note: You can adjust your browser settings (Chrome, Firefox, etc.) to delete or block cookies, though some parts of the Wonders of Rome site may not load correctly without them.</em></p>

                    <h3 id="widgets" className="text-2xl font-bold text-foreground mt-12">7. Third-Party Widgets</h3>
                    ...
                    <h3 id="pixels" className="text-2xl font-bold text-foreground mt-12">8. Tracking Pixels</h3>
                    ...
                    <h3 id="security" className="text-2xl font-bold text-foreground mt-12">9. Data Storage and Security</h3>
                    <ul className="list-disc pl-5 space-y-1">
                    ...
                    <p>Please write an email to <a href="mailto:info@wondersofrome.com" className="text-blue-700 font-bold hover:underline">{process.env.NEXT_PUBLIC_CONTACT_EMAIL || "info@romeagency.com"}</a> with your name, email address, and phone number to request removal. We will require identity verification before processing the request.</p>
                    ...
                    <h3 id="changes" className="text-2xl font-bold text-foreground mt-12">12. Changes to this Privacy Policy</h3>
                    ...
                    <p>If you wish to modify, correct, or delete your personal information, please contact us at <a href="mailto:info@wondersofrome.com" className="text-blue-700 font-bold hover:underline">{process.env.NEXT_PUBLIC_CONTACT_EMAIL || "info@romeagency.com"}</a>.</p>
                    <p>For our full contact info, visit: <a href="/contact" className="text-blue-700 font-bold hover:underline">https://wondersofrome.com/contact/</a></p>
                </div>
            </div>
