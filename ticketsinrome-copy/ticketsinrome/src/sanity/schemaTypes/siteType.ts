...
export const siteType = defineType({
    ...
    fields: [
        ...
        defineField({
            ...
            description: 'Display name of the website (e.g., "Rome Tour Tickets")',
            group: 'general',
        }),
        defineField({
            name: 'slug',
        ...
        defineField({
            ...
            title: 'Logo Text',
            type: 'string',
            description: 'Text logo if no image logo (e.g., "Tickets in Rome")',
            group: 'branding',
        }),
        defineField({
            name: 'logoTextAccent',
            ...
            type: 'string',
            description: 'Accent part of logo (e.g., "Rome" in "Tickets in Rome")',
            group: 'branding',
        }),
        defineField({
            name: 'favicon',
        ...
        defineField({
            ...
            fields: [
                defineField({
                    ...
                    title: 'Company Name',
                    type: 'string',
                    description: 'e.g., "Tickets in Rome S.r.l."',
                }),
                defineField({
                    name: 'vatNumber',
        ...
        defineField({
            ...
            type: 'string',
            description: 'WhatsApp number for the floating button (digits only, e.g., 3517869798)',
            group: 'contact',
        }),
        defineField({
            name: 'officeAddress',
