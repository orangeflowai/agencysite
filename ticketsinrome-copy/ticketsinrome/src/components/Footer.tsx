...
export default function Footer() {
    ...
    const vatNumber = businessInfo?.vatNumber || '03188940591';
    const reaNumber = businessInfo?.reaNumber || '319122';
    const registeredAddress = businessInfo?.registeredAddress || 'Via Nettunense 188, Aprilia (LT) 04011';
                                ...
                                <div className="flex items-center space-x-3">
                                    {socialLinks?.facebook && (
                                        <a
                                            ...
                                            aria-label="Facebook"
                                            className="w-10 h-10 rounded-full bg-stone-900 flex items-center justify-center text-stone-400 hover:bg-emerald-600 hover:text-white transition-all duration-300"
                                        >
                                            <Facebook size={18} />
                                        </a>
                                    )}
                                    ...
                                    {!hasSocialLinks && !site && (
                                        <>
                                            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-10 h-10 rounded-full bg-stone-900 flex items-center justify-center text-stone-400 hover:bg-emerald-600 hover:text-white transition-all duration-300">
                                                <Facebook size={18} />
                                            </a>
                                            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 rounded-full bg-stone-900 flex items-center justify-center text-stone-400 hover:bg-emerald-600 hover:text-white transition-all duration-300">
                                                <Instagram size={18} />
                                            </a>
                                            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="w-10 h-10 rounded-full bg-stone-900 flex items-center justify-center text-stone-400 hover:bg-emerald-600 hover:text-white transition-all duration-300">
                                                <Twitter size={18} />
                                            </a>
                                        </>
                                    )}
