                    ...
                    html: `
                        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                            ...
                            <div style="padding: 30px; background: #f9f9f7;">
                                ...
                                <p>Thank you for booking with ticketsinrome! Your reservation has been confirmed.</p>
                                ...
                                <p>Questions? Contact us at <a href="mailto:info@ticketsinrome.com">info@ticketsinrome.com</a></p>
                            </div>
                            <div style="background: #333; padding: 20px; text-align: center; color: #999; font-size: 12px;">
                                © 2026 ticketsinrome. All rights reserved.
                            </div>
                        </div>
                    `
                });
